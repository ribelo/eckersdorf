...
var G__38263 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__38263,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__38263;
}
});
...
var len__31516__auto___38268 = arguments.length;
var i__31517__auto___38269 = (0);
while(true){
if((i__31517__auto___38269 < len__31516__auto___38268)){
args__31523__auto__.push((arguments[i__31517__auto___38269]));

var G__38270 = (i__31517__auto___38269 + (1));
i__31517__auto___38269 = G__38270;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq38265){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38266,G__38267,seq38265__$2);
});
...
var file = cljs.core.get.call(null,map__38272__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__38272__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__38272__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__38272,map__38272__$1,file,line,column){
return (function (p1__38271_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__38271_SHARP_));
});})(map__38272,map__38272__$1,file,line,column))
...
var temp__5290__auto___38274 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5290__auto___38274)){
var message_38275 = temp__5290__auto___38274;
cljs.core.println.call(null,message_38275);
} else {
}
...
var temp__5290__auto___38276 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5290__auto___38276)){
var message_38277 = temp__5290__auto___38276;
cljs.core.println.call(null,message_38277);
} else {
}
...
var output_dir__$1 = (function (){var G__38278 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38278),"/"].join('');
} else {
return G__38278;
}
})();
...
var G__38280 = exception.stack;
var G__38280__$1 = (((G__38280 == null))?null:clojure.string.split_lines.call(null,G__38280));
var G__38280__$2 = (((G__38280__$1 == null))?null:cljs.core.get.call(null,G__38280__$1,depth));
if((G__38280__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__38280__$2);
}
} else {
...
var vec__38281 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__38281,(0),null);
var column = cljs.core.nth.call(null,vec__38281,(1),null);
var vec__38284 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__38284,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__38284,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__38284,(2),null);
...
var m__$1 = (function (){var G__38287 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__38291 = (function (){var G__38290 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__38290);
} else {
return G__38290;
}
})();
...
return cljs.core.vary_meta.call(null,G__38292,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__38296 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__38296,(0),null);
var types = vec__38296;
...
return cljs.core.map.call(null,(function (p__38299){
var vec__38300 = p__38299;
var ns = cljs.core.nth.call(null,vec__38300,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__38300,(1),null);
return ((function (vec__38300,ns,vars__$1){
return (function (){
...
var G__38303 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__38303,G__38303__$1,env,once_fixtures,each_fixtures,vec__38300,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__38303,G__38303__$1,env,once_fixtures,each_fixtures,vec__38300,ns,vars__$1){
return (function (){
var seq__38304 = cljs.core.seq.call(null,vars__$1);
var chunk__38305 = null;
var count__38306 = (0);
var i__38307 = (0);
while(true){
if((i__38307 < count__38306)){
var v = cljs.core._nth.call(null,chunk__38305,i__38307);
var temp__5290__auto___38309 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5290__auto___38309)){
var t_38310 = temp__5290__auto___38309;
each_fixture_fn.call(null,((function (seq__38304,chunk__38305,count__38306,i__38307,t_38310,temp__5290__auto___38309,v,each_fixture_fn,G__38303,G__38303__$1,env,once_fixtures,each_fixtures,vec__38300,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38310)));
});})(seq__38304,chunk__38305,count__38306,i__38307,t_38310,temp__5290__auto___38309,v,each_fixture_fn,G__38303,G__38303__$1,env,once_fixtures,each_fixtures,vec__38300,ns,vars__$1))
);
} else {
}

var G__38311 = seq__38304;
var G__38312 = chunk__38305;
var G__38313 = count__38306;
var G__38314 = (i__38307 + (1));
seq__38304 = G__38311;
chunk__38305 = G__38312;
count__38306 = G__38313;
i__38307 = G__38314;
continue;
} else {
var temp__5290__auto__ = cljs.core.seq.call(null,seq__38304);
if(temp__5290__auto__){
var seq__38304__$1 = temp__5290__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__38304__$1)){
var c__31170__auto__ = cljs.core.chunk_first.call(null,seq__38304__$1);
var G__38315 = cljs.core.chunk_rest.call(null,seq__38304__$1);
var G__38316 = c__31170__auto__;
var G__38317 = cljs.core.count.call(null,c__31170__auto__);
var G__38318 = (0);
seq__38304 = G__38315;
chunk__38305 = G__38316;
count__38306 = G__38317;
i__38307 = G__38318;
continue;
} else {
var v = cljs.core.first.call(null,seq__38304__$1);
var temp__5290__auto___38319__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5290__auto___38319__$1)){
var t_38320 = temp__5290__auto___38319__$1;
each_fixture_fn.call(null,((function (seq__38304,chunk__38305,count__38306,i__38307,t_38320,temp__5290__auto___38319__$1,v,seq__38304__$1,temp__5290__auto__,each_fixture_fn,G__38303,G__38303__$1,env,once_fixtures,each_fixtures,vec__38300,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38320)));
});})(seq__38304,chunk__38305,count__38306,i__38307,t_38320,temp__5290__auto___38319__$1,v,seq__38304__$1,temp__5290__auto__,each_fixture_fn,G__38303,G__38303__$1,env,once_fixtures,each_fixtures,vec__38300,ns,vars__$1))
);
} else {
}

var G__38321 = cljs.core.next.call(null,seq__38304__$1);
var G__38322 = null;
var G__38323 = (0);
var G__38324 = (0);
seq__38304 = G__38321;
chunk__38305 = G__38322;
count__38306 = G__38323;
i__38307 = G__38324;
continue;
}
} else {
...
});})(each_fixture_fn,G__38303,G__38303__$1,env,once_fixtures,each_fixtures,vec__38300,ns,vars__$1))
);
});})(each_fixture_fn,G__38303,G__38303__$1,env,once_fixtures,each_fixtures,vec__38300,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38303__$1)].join('')));

}
})());
});
;})(vec__38300,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1509094241800
