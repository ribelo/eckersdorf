...
return cljs.core.assoc.call(null,G__38483,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__38483;
}
});
...
var len__31526__auto___38488 = arguments.length;
var i__31527__auto___38489 = (0);
while(true){
if((i__31527__auto___38489 < len__31526__auto___38488)){
args__31533__auto__.push((arguments[i__31527__auto___38489]));

var G__38490 = (i__31527__auto___38489 + (1));
i__31527__auto___38489 = G__38490;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq38485){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38486,G__38487,seq38485__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__38492,map__38492__$1,file,line,column){
return (function (p1__38491_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__38491_SHARP_));
});})(map__38492,map__38492__$1,file,line,column))
...
var temp__5290__auto___38494 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5290__auto___38494)){
var message_38495 = temp__5290__auto___38494;
cljs.core.println.call(null,message_38495);
} else {
}
...
var temp__5290__auto___38496 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5290__auto___38496)){
var message_38497 = temp__5290__auto___38496;
cljs.core.println.call(null,message_38497);
} else {
}
...
var output_dir__$1 = (function (){var G__38498 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38498),"/"].join('');
} else {
return G__38498;
}
})();
...
var G__38500 = exception.stack;
var G__38500__$1 = (((G__38500 == null))?null:clojure.string.split_lines.call(null,G__38500));
var G__38500__$2 = (((G__38500__$1 == null))?null:cljs.core.get.call(null,G__38500__$1,depth));
if((G__38500__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__38500__$2);
}
} else {
...
var vec__38501 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__38501,(0),null);
var column = cljs.core.nth.call(null,vec__38501,(1),null);
var vec__38504 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__38504,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__38504,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__38504,(2),null);
...
var m__$1 = (function (){var G__38507 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__38511 = (function (){var G__38510 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__38510);
} else {
return G__38510;
}
})();
...
return cljs.core.vary_meta.call(null,G__38512,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__38514 = e;
var G__38514__$1 = (((G__38514 instanceof cljs.core.Keyword))?G__38514.fqn:null);
switch (G__38514__$1) {
...
var vec__38516 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__38516,(0),null);
var types = vec__38516;
...
return cljs.core.map.call(null,(function (p__38519){
var vec__38520 = p__38519;
var ns = cljs.core.nth.call(null,vec__38520,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__38520,(1),null);
return ((function (vec__38520,ns,vars__$1){
return (function (){
...
var G__38523 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__38523,G__38523__$1,env,once_fixtures,each_fixtures,vec__38520,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__38523,G__38523__$1,env,once_fixtures,each_fixtures,vec__38520,ns,vars__$1){
return (function (){
var seq__38524 = cljs.core.seq.call(null,vars__$1);
var chunk__38525 = null;
var count__38526 = (0);
var i__38527 = (0);
while(true){
if((i__38527 < count__38526)){
var v = cljs.core._nth.call(null,chunk__38525,i__38527);
var temp__5290__auto___38529 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5290__auto___38529)){
var t_38530 = temp__5290__auto___38529;
each_fixture_fn.call(null,((function (seq__38524,chunk__38525,count__38526,i__38527,t_38530,temp__5290__auto___38529,v,each_fixture_fn,G__38523,G__38523__$1,env,once_fixtures,each_fixtures,vec__38520,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38530)));
});})(seq__38524,chunk__38525,count__38526,i__38527,t_38530,temp__5290__auto___38529,v,each_fixture_fn,G__38523,G__38523__$1,env,once_fixtures,each_fixtures,vec__38520,ns,vars__$1))
);
} else {
}

var G__38531 = seq__38524;
var G__38532 = chunk__38525;
var G__38533 = count__38526;
var G__38534 = (i__38527 + (1));
seq__38524 = G__38531;
chunk__38525 = G__38532;
count__38526 = G__38533;
i__38527 = G__38534;
continue;
} else {
var temp__5290__auto__ = cljs.core.seq.call(null,seq__38524);
if(temp__5290__auto__){
var seq__38524__$1 = temp__5290__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__38524__$1)){
var c__31180__auto__ = cljs.core.chunk_first.call(null,seq__38524__$1);
var G__38535 = cljs.core.chunk_rest.call(null,seq__38524__$1);
var G__38536 = c__31180__auto__;
var G__38537 = cljs.core.count.call(null,c__31180__auto__);
var G__38538 = (0);
seq__38524 = G__38535;
chunk__38525 = G__38536;
count__38526 = G__38537;
i__38527 = G__38538;
continue;
} else {
var v = cljs.core.first.call(null,seq__38524__$1);
var temp__5290__auto___38539__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5290__auto___38539__$1)){
var t_38540 = temp__5290__auto___38539__$1;
each_fixture_fn.call(null,((function (seq__38524,chunk__38525,count__38526,i__38527,t_38540,temp__5290__auto___38539__$1,v,seq__38524__$1,temp__5290__auto__,each_fixture_fn,G__38523,G__38523__$1,env,once_fixtures,each_fixtures,vec__38520,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_38540)));
});})(seq__38524,chunk__38525,count__38526,i__38527,t_38540,temp__5290__auto___38539__$1,v,seq__38524__$1,temp__5290__auto__,each_fixture_fn,G__38523,G__38523__$1,env,once_fixtures,each_fixtures,vec__38520,ns,vars__$1))
);
} else {
}

var G__38541 = cljs.core.next.call(null,seq__38524__$1);
var G__38542 = null;
var G__38543 = (0);
var G__38544 = (0);
seq__38524 = G__38541;
chunk__38525 = G__38542;
count__38526 = G__38543;
i__38527 = G__38544;
continue;
}
} else {
...
});})(each_fixture_fn,G__38523,G__38523__$1,env,once_fixtures,each_fixtures,vec__38520,ns,vars__$1))
);
});})(each_fixture_fn,G__38523,G__38523__$1,env,once_fixtures,each_fixtures,vec__38520,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38523__$1)].join('')));

}
})());
});
;})(vec__38520,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1506023161628
