...
var G__35112 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__35112,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__35112;
}
});
...
var len__31526__auto___35117 = arguments.length;
var i__31527__auto___35118 = (0);
while(true){
if((i__31527__auto___35118 < len__31526__auto___35117)){
args__31533__auto__.push((arguments[i__31527__auto___35118]));

var G__35119 = (i__31527__auto___35118 + (1));
i__31527__auto___35118 = G__35119;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq35114){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__35115,G__35116,seq35114__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__35121,map__35121__$1,file,line,column){
return (function (p1__35120_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__35120_SHARP_));
});})(map__35121,map__35121__$1,file,line,column))
...
var temp__5290__auto___35123 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5290__auto___35123)){
var message_35124 = temp__5290__auto___35123;
...
var temp__5290__auto___35125 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5290__auto___35125)){
var message_35126 = temp__5290__auto___35125;
cljs.core.println.call(null,message_35126);
} else {
}
...
var output_dir__$1 = (function (){var G__35127 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35127),"/"].join('');
} else {
return G__35127;
}
})();
...
var G__35129 = exception.stack;
var G__35129__$1 = (((G__35129 == null))?null:clojure.string.split_lines.call(null,G__35129));
var G__35129__$2 = (((G__35129__$1 == null))?null:cljs.core.get.call(null,G__35129__$1,depth));
if((G__35129__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__35129__$2);
}
} else {
...
var vec__35130 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__35130,(0),null);
var column = cljs.core.nth.call(null,vec__35130,(1),null);
var vec__35133 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__35133,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__35133,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__35133,(2),null);
...
var m__$1 = (function (){var G__35136 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__35140 = (function (){var G__35139 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__35139);
} else {
return G__35139;
}
})();
...
return cljs.core.vary_meta.call(null,G__35141,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e35142){var e = e35142;
var G__35143 = e;
var G__35143__$1 = (((G__35143 instanceof cljs.core.Keyword))?G__35143.fqn:null);
switch (G__35143__$1) {
...
var vec__35145 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__35145,(0),null);
var types = vec__35145;
...
var ns = cljs.core.nth.call(null,vec__35149,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__35149,(1),null);
return ((function (vec__35149,ns,vars__$1){
return (function (){
...
var G__35152 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__35152,G__35152__$1,env,once_fixtures,each_fixtures,vec__35149,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__35152,G__35152__$1,env,once_fixtures,each_fixtures,vec__35149,ns,vars__$1){
return (function (){
var seq__35153 = cljs.core.seq.call(null,vars__$1);
var chunk__35154 = null;
var count__35155 = (0);
var i__35156 = (0);
while(true){
if((i__35156 < count__35155)){
var v = cljs.core._nth.call(null,chunk__35154,i__35156);
var temp__5290__auto___35158 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5290__auto___35158)){
var t_35159 = temp__5290__auto___35158;
each_fixture_fn.call(null,((function (seq__35153,chunk__35154,count__35155,i__35156,t_35159,temp__5290__auto___35158,v,each_fixture_fn,G__35152,G__35152__$1,env,once_fixtures,each_fixtures,vec__35149,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35159)));
});})(seq__35153,chunk__35154,count__35155,i__35156,t_35159,temp__5290__auto___35158,v,each_fixture_fn,G__35152,G__35152__$1,env,once_fixtures,each_fixtures,vec__35149,ns,vars__$1))
);
} else {
}

var G__35160 = seq__35153;
var G__35161 = chunk__35154;
var G__35162 = count__35155;
var G__35163 = (i__35156 + (1));
seq__35153 = G__35160;
chunk__35154 = G__35161;
count__35155 = G__35162;
i__35156 = G__35163;
continue;
} else {
var temp__5290__auto__ = cljs.core.seq.call(null,seq__35153);
if(temp__5290__auto__){
var seq__35153__$1 = temp__5290__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__35153__$1)){
var c__31180__auto__ = cljs.core.chunk_first.call(null,seq__35153__$1);
var G__35164 = cljs.core.chunk_rest.call(null,seq__35153__$1);
var G__35165 = c__31180__auto__;
var G__35166 = cljs.core.count.call(null,c__31180__auto__);
var G__35167 = (0);
seq__35153 = G__35164;
chunk__35154 = G__35165;
count__35155 = G__35166;
i__35156 = G__35167;
continue;
} else {
var v = cljs.core.first.call(null,seq__35153__$1);
var temp__5290__auto___35168__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5290__auto___35168__$1)){
var t_35169 = temp__5290__auto___35168__$1;
each_fixture_fn.call(null,((function (seq__35153,chunk__35154,count__35155,i__35156,t_35169,temp__5290__auto___35168__$1,v,seq__35153__$1,temp__5290__auto__,each_fixture_fn,G__35152,G__35152__$1,env,once_fixtures,each_fixtures,vec__35149,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35169)));
});})(seq__35153,chunk__35154,count__35155,i__35156,t_35169,temp__5290__auto___35168__$1,v,seq__35153__$1,temp__5290__auto__,each_fixture_fn,G__35152,G__35152__$1,env,once_fixtures,each_fixtures,vec__35149,ns,vars__$1))
);
} else {
}

var G__35170 = cljs.core.next.call(null,seq__35153__$1);
var G__35171 = null;
var G__35172 = (0);
var G__35173 = (0);
seq__35153 = G__35170;
chunk__35154 = G__35171;
count__35155 = G__35172;
i__35156 = G__35173;
continue;
}
} else {
...
});})(each_fixture_fn,G__35152,G__35152__$1,env,once_fixtures,each_fixtures,vec__35149,ns,vars__$1))
);
});})(each_fixture_fn,G__35152,G__35152__$1,env,once_fixtures,each_fixtures,vec__35149,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35152__$1)].join('')));

}
})());
});
;})(vec__35149,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1509397940608
