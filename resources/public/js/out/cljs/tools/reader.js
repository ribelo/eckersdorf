...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__52865 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__52865,ch);
...
if(("\\" === ch__$1)){
var ch_52866__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_52866__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_52866__$2);
} else {
}

var G__52867 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__52867;
continue;
}
}
...
var vec__52875 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__52875,(0),null);
var start_column = cljs.core.nth.call(null,vec__52875,(1),null);
...
var G__52878 = cljs.core.conj_BANG_.call(null,a,form);
a = G__52878;
continue;
}
}
...
var _STAR_read_delim_STAR_52879 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_52879;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__52880 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__52880,(0),null);
var start_column = cljs.core.nth.call(null,vec__52880,(1),null);
...
var vec__52883 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__52883,(0),null);
var end_column = cljs.core.nth.call(null,vec__52883,(1),null);
...
var vec__52886 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__52886,(0),null);
var start_column = cljs.core.nth.call(null,vec__52886,(1),null);
...
var vec__52889 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__52889,(0),null);
var end_column = cljs.core.nth.call(null,vec__52889,(1),null);
...
var vec__52892 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__52892,(0),null);
var start_column = cljs.core.nth.call(null,vec__52892,(1),null);
...
var vec__52895 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__52895,(0),null);
var end_column = cljs.core.nth.call(null,vec__52895,(1),null);
...
var sb = (function (){var G__52898 = (new goog.string.StringBuffer());
G__52898.append(initch);
...
var G__52900 = (function (){var G__52899 = sb;
G__52899.append(ch);

return G__52899;
})();
var G__52901 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__52900;
ch = G__52901;
continue;
}
...
switch (G__52904) {
case "\\":
var G__52908 = (function (){var G__52905 = sb;
G__52905.append(cljs.tools.reader.escape_char.call(null,sb,reader));
...
break;
default:
var G__52910 = (function (){var G__52906 = sb;
G__52906.append(ch);

return G__52906;
})();
var G__52911 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__52910;
ch = G__52911;
continue;
...
var vec__52912 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__52912,(0),null);
var end_column = cljs.core.nth.call(null,vec__52912,(1),null);
...
var vec__52915 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__52915,(0),null);
var column = cljs.core.nth.call(null,vec__52915,(1),null);
...
var vec__52920 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__52920,(0),null);
var column = cljs.core.nth.call(null,vec__52920,(1),null);
...
var vec__52925 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__52925,(0),null);
var column = cljs.core.nth.call(null,vec__52925,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__52930 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__52930,(0),null);
var start_column = cljs.core.nth.call(null,vec__52930,(1),null);
...
var vec__52933 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__52933,(0),null);
var end_column = cljs.core.nth.call(null,vec__52933,(1),null);
...
var G__52936 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__52936,true,null,opts,pending_forms);
...
var G__52937 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__52937)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__52937)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__52937)){
...
var _STAR_suppress_read_STAR_52938 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_52938;
}});
...
var G__52939 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__52939,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__52939,rdr,first_line);
...
var G__52943 = matched;
var G__52944 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__52943;
finished = G__52944;
continue;
} else {
...
var _STAR_suppress_read_STAR_52945 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_52945;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env52946 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__52947 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__52947,"(");
...
var G__52948 = (i + (1));
var G__52949 = cljs.core.conj_BANG_.call(null,args,(function (){var or__30522__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env52946;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__52950 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__52950);
...
var G__52951 = cljs.core.next.call(null,s__$1);
var G__52952 = ret;
s__$1 = G__52951;
r = G__52952;
continue;
...
var G__52953 = cljs.core.next.call(null,s);
var G__52954 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__52953;
key_vals = G__52954;
continue;
} else {
...
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__31477__auto__);
})(),new cljs.core.Symbol(null,"quote","quote",1377916282,null)):(((form instanceof cljs.core.Symbol))?cljs.core._conj.call(null,(function (){var x__31477__auto__ = (cljs.core.truth_((function (){var and__30510__auto__ = cljs.core.not.call(null,cljs.core.namespace.call(null,form));
if(and__30510__auto__){
...
var gensym_env52958 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env52958;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__52959 = token;
var G__52959__$1 = (((G__52959 == null))?null:cljs.core.subs.call(null,G__52959,(1)));
var G__52959__$2 = (((G__52959__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__52959__$1));
var G__52959__$3 = (((G__52959__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__52959__$2));
var G__52959__$4 = (((G__52959__$3 == null))?null:cljs.core.symbol.call(null,G__52959__$3));
if((G__52959__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__52959__$4);
}
})():(function (){var G__52960 = token;
var G__52960__$1 = (((G__52960 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__52960));
if((G__52960__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__52960__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e52967){if((e52967 instanceof Error)){
var e = e52967;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__52971,reader){
var map__52972 = p__52971;
var map__52972__$1 = ((((!((map__52972 == null)))?((((map__52972.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52972.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52972):map__52972);
var opts = map__52972__$1;
var eof = cljs.core.get.call(null,map__52972__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1510703510071
