...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword("contacts","filtered","contacts/filtered",64153716),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("contacts","list","contacts/list",1198689742)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("contacts","search-form","contacts/search-form",1073014637)], null),(function (p__45294,_){
var vec__45295 = p__45294;
var contacts = cljs.core.nth.call(null,vec__45295,(0),null);
var search = cljs.core.nth.call(null,vec__45295,(1),null);
if(!(cljs.core.empty_QMARK_.call(null,search))){
return cljs.core.filter.call(null,((function (vec__45295,contacts,search){
return (function (p__45298){
var map__45299 = p__45298;
var map__45299__$1 = ((((!((map__45299 == null)))?((((map__45299.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45299.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45299):map__45299);
var first_name = cljs.core.get.call(null,map__45299__$1,new cljs.core.Keyword("contact","first-name","contact/first-name",-365071315));
var last_name = cljs.core.get.call(null,map__45299__$1,new cljs.core.Keyword("contact","last-name","contact/last-name",-1539952766));
var phone_number = cljs.core.get.call(null,map__45299__$1,new cljs.core.Keyword("contact","phone-number","contact/phone-number",-766137276));
var email_address = cljs.core.get.call(null,map__45299__$1,new cljs.core.Keyword("contact","email-address","contact/email-address",-1363984584));
var company = cljs.core.get.call(null,map__45299__$1,new cljs.core.Keyword("contact","company","contact/company",1357719325));
var title = cljs.core.get.call(null,map__45299__$1,new cljs.core.Keyword("contact","title","contact/title",-151426609));
var or__30523__auto__ = (cljs.core.truth_(first_name)?cljs.core.re_find.call(null,cljs.core.re_pattern.call(null,["(?iu)",cljs.core.str.cljs$core$IFn$_invoke$arity$1(search)].join('')),first_name):null);
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
var or__30523__auto____$1 = (cljs.core.truth_(last_name)?cljs.core.re_find.call(null,cljs.core.re_pattern.call(null,["(?iu)",cljs.core.str.cljs$core$IFn$_invoke$arity$1(search)].join('')),last_name):null);
if(cljs.core.truth_(or__30523__auto____$1)){
return or__30523__auto____$1;
} else {
var or__30523__auto____$2 = (cljs.core.truth_(phone_number)?cljs.core.re_find.call(null,cljs.core.re_pattern.call(null,["(?iu)",cljs.core.str.cljs$core$IFn$_invoke$arity$1(search)].join('')),phone_number):null);
if(cljs.core.truth_(or__30523__auto____$2)){
return or__30523__auto____$2;
} else {
var or__30523__auto____$3 = (cljs.core.truth_(email_address)?cljs.core.re_find.call(null,cljs.core.re_pattern.call(null,["(?iu)",cljs.core.str.cljs$core$IFn$_invoke$arity$1(search)].join('')),email_address):null);
if(cljs.core.truth_(or__30523__auto____$3)){
return or__30523__auto____$3;
} else {
var or__30523__auto____$4 = (cljs.core.truth_(company)?cljs.core.re_find.call(null,cljs.core.re_pattern.call(null,["(?iu)",cljs.core.str.cljs$core$IFn$_invoke$arity$1(search)].join('')),company):null);
...
var _ = cljs.core.nth.call(null,vec__45303,(0),null);
var contact_id = cljs.core.nth.call(null,vec__45303,(1),null);
return cljs.core.first.call(null,cljs.core.filter.call(null,((function (vec__45303,_,contact_id){
return (function (p1__45301_SHARP_){
return cljs.core._EQ_.call(null,contact_id,new cljs.core.Keyword("mongo","object-id","mongo/object-id",-1464142663).cljs$core$IFn$_invoke$arity$1(p1__45301_SHARP_));
});})(vec__45303,_,contact_id))
,contacts));
}));
...
//# sourceMappingURL=subs.js.map?rel=1510609300344
