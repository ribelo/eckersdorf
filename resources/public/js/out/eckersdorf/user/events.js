...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-first-name","user/set-first-name",207588561),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__44622){
var vec__44623 = p__44622;
var _ = cljs.core.nth.call(null,vec__44623,(0),null);
var first_name = cljs.core.nth.call(null,vec__44623,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","first-name","user/first-name",-1564894072),first_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__44626){
var vec__44627 = p__44626;
var _ = cljs.core.nth.call(null,vec__44627,(0),null);
var last_name = cljs.core.nth.call(null,vec__44627,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),last_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-email-address","user/set-email-address",-1886211964),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__44630){
var vec__44631 = p__44630;
var _ = cljs.core.nth.call(null,vec__44631,(0),null);
var email_address = cljs.core.nth.call(null,vec__44631,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-phone-number","user/set-phone-number",570586055),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__44634){
var vec__44635 = p__44634;
var _ = cljs.core.nth.call(null,vec__44635,(0),null);
var phone_number = cljs.core.nth.call(null,vec__44635,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update","user/request-update",1510973894),(function (p__44638,_){
...
var db = cljs.core.get.call(null,map__44639__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-success","user/request-update-success",1709439749),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (p__44641,p__44642){
var map__44643 = p__44641;
...
var db = cljs.core.get.call(null,map__44643__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__44644 = p__44642;
var _ = cljs.core.nth.call(null,vec__44644,(0),null);
var response = cljs.core.nth.call(null,vec__44644,(1),null);
taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"eckersdorf.user.events","/tmp/form-init1472310278782481327.clj",81,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (map__44643,map__44643__$1,db,vec__44644,_,response){
return (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response], null);
});})(map__44643,map__44643__$1,db,vec__44644,_,response))
,null)),null,218017143);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-failure","user/request-update-failure",-689072023),(function (p__44648,p__44649){
...
var db = cljs.core.get.call(null,map__44650__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__44651 = p__44649;
var _ = cljs.core.nth.call(null,vec__44651,(0),null);
var response = cljs.core.nth.call(null,vec__44651,(1),null);
...
//# sourceMappingURL=events.js.map?rel=1510602151888
