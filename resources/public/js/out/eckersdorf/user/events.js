...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-first-name","user/set-first-name",207588561),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43810){
var vec__43811 = p__43810;
var _ = cljs.core.nth.call(null,vec__43811,(0),null);
var first_name = cljs.core.nth.call(null,vec__43811,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","first-name","user/first-name",-1564894072),first_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43814){
var vec__43815 = p__43814;
var _ = cljs.core.nth.call(null,vec__43815,(0),null);
var last_name = cljs.core.nth.call(null,vec__43815,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),last_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-email-address","user/set-email-address",-1886211964),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43818){
var vec__43819 = p__43818;
var _ = cljs.core.nth.call(null,vec__43819,(0),null);
var email_address = cljs.core.nth.call(null,vec__43819,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-phone-number","user/set-phone-number",570586055),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43822){
var vec__43823 = p__43822;
var _ = cljs.core.nth.call(null,vec__43823,(0),null);
var phone_number = cljs.core.nth.call(null,vec__43823,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update","user/request-update",1510973894),(function (p__43826,_){
...
var db = cljs.core.get.call(null,map__43827__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-success","user/request-update-success",1709439749),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (p__43829,p__43830){
var map__43831 = p__43829;
var map__43831__$1 = ((((!((map__43831 == null)))?((((map__43831.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43831.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43831):map__43831);
var db = cljs.core.get.call(null,map__43831__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__43832 = p__43830;
var _ = cljs.core.nth.call(null,vec__43832,(0),null);
var response = cljs.core.nth.call(null,vec__43832,(1),null);
taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"eckersdorf.user.events","/tmp/form-init7144371711362589933.clj",82,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (map__43831,map__43831__$1,db,vec__43832,_,response){
return (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response], null);
});})(map__43831,map__43831__$1,db,vec__43832,_,response))
,null)),null,1121062433);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-failure","user/request-update-failure",-689072023),(function (p__43836,p__43837){
...
//# sourceMappingURL=events.js.map?rel=1507757462129
