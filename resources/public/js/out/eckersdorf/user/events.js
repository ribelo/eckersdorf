...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-first-name","user/set-first-name",207588561),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__59690){
var vec__59691 = p__59690;
var _ = cljs.core.nth.call(null,vec__59691,(0),null);
var first_name = cljs.core.nth.call(null,vec__59691,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","first-name","user/first-name",-1564894072),first_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__59694){
var vec__59695 = p__59694;
var _ = cljs.core.nth.call(null,vec__59695,(0),null);
var last_name = cljs.core.nth.call(null,vec__59695,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),last_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-email-address","user/set-email-address",-1886211964),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__59698){
var vec__59699 = p__59698;
var _ = cljs.core.nth.call(null,vec__59699,(0),null);
var email_address = cljs.core.nth.call(null,vec__59699,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-phone-number","user/set-phone-number",570586055),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__59702){
var vec__59703 = p__59702;
var _ = cljs.core.nth.call(null,vec__59703,(0),null);
var phone_number = cljs.core.nth.call(null,vec__59703,(1),null);
...
cljs.core.println.call(null,new cljs.core.Keyword("user","refresh-last-login","user/refresh-last-login",-341546479));
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update","user/request-update",1510973894),(function (p__59706,_){
var map__59707 = p__59706;
var map__59707__$1 = ((((!((map__59707 == null)))?((((map__59707.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59707.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__59707):map__59707);
var db = cljs.core.get.call(null,map__59707__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-success","user/request-update-success",1709439749),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (p__59709,p__59710){
var map__59711 = p__59709;
var map__59711__$1 = ((((!((map__59711 == null)))?((((map__59711.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59711.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__59711):map__59711);
var db = cljs.core.get.call(null,map__59711__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__59712 = p__59710;
var _ = cljs.core.nth.call(null,vec__59712,(0),null);
var response = cljs.core.nth.call(null,vec__59712,(1),null);
taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"eckersdorf.user.events","/tmp/form-init2034828343720151013.clj",82,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (map__59711,map__59711__$1,db,vec__59712,_,response){
return (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response], null);
});})(map__59711,map__59711__$1,db,vec__59712,_,response))
,null)),null,788855110);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-failure","user/request-update-failure",-689072023),(function (p__59716,p__59717){
var map__59718 = p__59716;
var map__59718__$1 = ((((!((map__59718 == null)))?((((map__59718.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59718.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__59718):map__59718);
var db = cljs.core.get.call(null,map__59718__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__59719 = p__59717;
var _ = cljs.core.nth.call(null,vec__59719,(0),null);
var response = cljs.core.nth.call(null,vec__59719,(1),null);
...
//# sourceMappingURL=events.js.map?rel=1507060430990
