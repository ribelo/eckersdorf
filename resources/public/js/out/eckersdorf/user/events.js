...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-first-name","user/set-first-name",207588561),(function (db,p__39699){
var vec__39700 = p__39699;
var _ = cljs.core.nth.call(null,vec__39700,(0),null);
var first_name = cljs.core.nth.call(null,vec__39700,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","first-name","user/first-name",-1564894072),first_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),(function (db,p__39703){
var vec__39704 = p__39703;
var _ = cljs.core.nth.call(null,vec__39704,(0),null);
var last_name = cljs.core.nth.call(null,vec__39704,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),last_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-email-address","user/set-email-address",-1886211964),(function (db,p__39707){
var vec__39708 = p__39707;
var _ = cljs.core.nth.call(null,vec__39708,(0),null);
var email_address = cljs.core.nth.call(null,vec__39708,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-phone-number","user/set-phone-number",570586055),(function (db,p__39711){
var vec__39712 = p__39711;
var _ = cljs.core.nth.call(null,vec__39712,(0),null);
var phone_number = cljs.core.nth.call(null,vec__39712,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update","user/request-update",1510973894),(function (p__39715,_){
...
var db = cljs.core.get.call(null,map__39716__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-success","user/request-update-success",1709439749),(function (p__39718,p__39719){
var map__39720 = p__39718;
...
var db = cljs.core.get.call(null,map__39720__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__39721 = p__39719;
var _ = cljs.core.nth.call(null,vec__39721,(0),null);
var response = cljs.core.nth.call(null,vec__39721,(1),null);
taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"eckersdorf.user.events","/tmp/form-init3362738151470525117.clj",67,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (map__39720,map__39720__$1,db,vec__39721,_,response){
return (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response], null);
});})(map__39720,map__39720__$1,db,vec__39721,_,response))
,null)),null,-1146626505);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-failure","user/request-update-failure",-689072023),(function (p__39725,p__39726){
var map__39727 = p__39725;
...
var db = cljs.core.get.call(null,map__39727__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__39728 = p__39726;
var _ = cljs.core.nth.call(null,vec__39728,(0),null);
var response = cljs.core.nth.call(null,vec__39728,(1),null);
...
//# sourceMappingURL=events.js.map?rel=1506535793382
