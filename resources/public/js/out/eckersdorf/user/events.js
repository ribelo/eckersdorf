...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-first-name","user/set-first-name",207588561),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43926){
var vec__43927 = p__43926;
var _ = cljs.core.nth.call(null,vec__43927,(0),null);
var first_name = cljs.core.nth.call(null,vec__43927,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","first-name","user/first-name",-1564894072),first_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43930){
var vec__43931 = p__43930;
var _ = cljs.core.nth.call(null,vec__43931,(0),null);
var last_name = cljs.core.nth.call(null,vec__43931,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),last_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-email-address","user/set-email-address",-1886211964),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43934){
var vec__43935 = p__43934;
var _ = cljs.core.nth.call(null,vec__43935,(0),null);
var email_address = cljs.core.nth.call(null,vec__43935,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-phone-number","user/set-phone-number",570586055),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43938){
var vec__43939 = p__43938;
var _ = cljs.core.nth.call(null,vec__43939,(0),null);
var phone_number = cljs.core.nth.call(null,vec__43939,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update","user/request-update",1510973894),(function (p__43942,_){
...
var db = cljs.core.get.call(null,map__43943__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-success","user/request-update-success",1709439749),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (p__43945,p__43946){
var map__43947 = p__43945;
...
var db = cljs.core.get.call(null,map__43947__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__43948 = p__43946;
var _ = cljs.core.nth.call(null,vec__43948,(0),null);
var response = cljs.core.nth.call(null,vec__43948,(1),null);
taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"eckersdorf.user.events","/tmp/form-init871657641513922697.clj",82,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (map__43947,map__43947__$1,db,vec__43948,_,response){
return (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response], null);
});})(map__43947,map__43947__$1,db,vec__43948,_,response))
,null)),null,689116695);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-failure","user/request-update-failure",-689072023),(function (p__43952,p__43953){
var map__43954 = p__43952;
var map__43954__$1 = ((((!((map__43954 == null)))?((((map__43954.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43954.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43954):map__43954);
var db = cljs.core.get.call(null,map__43954__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__43955 = p__43953;
var _ = cljs.core.nth.call(null,vec__43955,(0),null);
var response = cljs.core.nth.call(null,vec__43955,(1),null);
...
//# sourceMappingURL=events.js.map?rel=1509094248382
