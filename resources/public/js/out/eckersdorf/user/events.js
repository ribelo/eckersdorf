...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-first-name","user/set-first-name",207588561),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43844){
var vec__43845 = p__43844;
var _ = cljs.core.nth.call(null,vec__43845,(0),null);
var first_name = cljs.core.nth.call(null,vec__43845,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","first-name","user/first-name",-1564894072),first_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43848){
var vec__43849 = p__43848;
var _ = cljs.core.nth.call(null,vec__43849,(0),null);
var last_name = cljs.core.nth.call(null,vec__43849,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("user","set-last-name","user/set-last-name",-1524400017),last_name);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-email-address","user/set-email-address",-1886211964),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43852){
var vec__43853 = p__43852;
var _ = cljs.core.nth.call(null,vec__43853,(0),null);
var email_address = cljs.core.nth.call(null,vec__43853,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("user","set-phone-number","user/set-phone-number",570586055),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (db,p__43856){
var vec__43857 = p__43856;
var _ = cljs.core.nth.call(null,vec__43857,(0),null);
var phone_number = cljs.core.nth.call(null,vec__43857,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update","user/request-update",1510973894),(function (p__43860,_){
var map__43861 = p__43860;
var map__43861__$1 = ((((!((map__43861 == null)))?((((map__43861.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43861.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43861):map__43861);
var db = cljs.core.get.call(null,map__43861__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-success","user/request-update-success",1709439749),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (p__43863,p__43864){
var map__43865 = p__43863;
var map__43865__$1 = ((((!((map__43865 == null)))?((((map__43865.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43865.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43865):map__43865);
var db = cljs.core.get.call(null,map__43865__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__43866 = p__43864;
var _ = cljs.core.nth.call(null,vec__43866,(0),null);
var response = cljs.core.nth.call(null,vec__43866,(1),null);
taoensso.timbre._log_BANG_.call(null,taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"info","info",-317069002),"eckersdorf.user.events","/tmp/form-init4624309513201810004.clj",82,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (map__43865,map__43865__$1,db,vec__43866,_,response){
return (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response], null);
});})(map__43865,map__43865__$1,db,vec__43866,_,response))
,null)),null,-762986772);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("user","request-update-failure","user/request-update-failure",-689072023),(function (p__43870,p__43871){
var map__43872 = p__43870;
...
var db = cljs.core.get.call(null,map__43872__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__43873 = p__43871;
var _ = cljs.core.nth.call(null,vec__43873,(0),null);
var response = cljs.core.nth.call(null,vec__43873,(1),null);
...
//# sourceMappingURL=events.js.map?rel=1508862160520
