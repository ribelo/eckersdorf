...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("login","set-email-address","login/set-email-address",-1716802526),(function (db,p__45124){
var vec__45125 = p__45124;
var _ = cljs.core.nth.call(null,vec__45125,(0),null);
var email = cljs.core.nth.call(null,vec__45125,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("login","email-address","login/email-address",-870577041),email);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("login","set-password","login/set-password",-937455710),(function (db,p__45128){
var vec__45129 = p__45128;
var _ = cljs.core.nth.call(null,vec__45129,(0),null);
var password = cljs.core.nth.call(null,vec__45129,(1),null);
return cljs.core.assoc.call(null,db,new cljs.core.Keyword("login","password","login/password",464605936),password);
}));
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("login","set-invalid-password","login/set-invalid-password",-441133969),(function (db,p__45132){
var vec__45133 = p__45132;
var _ = cljs.core.nth.call(null,vec__45133,(0),null);
var status = cljs.core.nth.call(null,vec__45133,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("login","request-login","login/request-login",-6563777),(function (p__45136,_){
var map__45137 = p__45136;
var map__45137__$1 = ((((!((map__45137 == null)))?((((map__45137.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45137.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45137):map__45137);
var db = cljs.core.get.call(null,map__45137__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("login","request-login-success","login/request-login-success",1643197465),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [eckersdorf.db.core.__GT_local_storage], null),(function (p__45139,p__45140){
...
var db = cljs.core.get.call(null,map__45141__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__45142 = p__45140;
var _ = cljs.core.nth.call(null,vec__45142,(0),null);
var response = cljs.core.nth.call(null,vec__45142,(1),null);
...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("login","request-login-failure","login/request-login-failure",1582510396),(function (p__45146,p__45147){
...
var db = cljs.core.get.call(null,map__45148__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__45149 = p__45147;
var _ = cljs.core.nth.call(null,vec__45149,(0),null);
var map__45152 = cljs.core.nth.call(null,vec__45149,(1),null);
...
var response = map__45152__$1;
var status = cljs.core.get.call(null,map__45152__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var G__45155 = status;
switch (G__45155) {
case (401):
...
//# sourceMappingURL=events.js.map?rel=1510602152720
