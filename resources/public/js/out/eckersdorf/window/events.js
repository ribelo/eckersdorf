...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("window","update-breakpoint","window/update-breakpoint",1517550785),(function (p__42404,_){
...
var db = map__42405__$1;
var width = cljs.core.get.call(null,map__42405__$1,new cljs.core.Keyword("window","width","window/width",-1138776901));
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("layout","update-columns","layout/update-columns",1792953905),(function (p__42407,_){
...
var db = map__42408__$1;
var width = cljs.core.get.call(null,map__42408__$1,new cljs.core.Keyword("window","width","window/width",-1138776901));
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("layout","update-gutter","layout/update-gutter",-832825682),(function (p__42410,_){
var map__42411 = p__42410;
var map__42411__$1 = ((((!((map__42411 == null)))?((((map__42411.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42411.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42411):map__42411);
var db = map__42411__$1;
var width = cljs.core.get.call(null,map__42411__$1,new cljs.core.Keyword("window","width","window/width",-1138776901));
...
var resize_state_42413 = cljs.core.atom.call(null,null);
window.addEventListener("resize",((function (resize_state_42413){
return (function (){
clearTimeout(cljs.core.deref.call(null,resize_state_42413));

var timeout = setTimeout(((function (resize_state_42413){
return (function (){
...
,(500));
return cljs.core.reset_BANG_.call(null,resize_state_42413,timeout);
});})(resize_state_42413))
);
...
//# sourceMappingURL=events.js.map?rel=1510602148884
