...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword("workers","by-workplace-id","workers/by-workplace-id",1364741936),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("workers","list","workers/list",-759802960)], null),(function (workers,p__52837){
var vec__52838 = p__52837;
var _ = cljs.core.nth.call(null,vec__52838,(0),null);
var workplace_id = cljs.core.nth.call(null,vec__52838,(1),null);
return cljs.core.filter.call(null,((function (vec__52838,_,workplace_id){
return (function (p1__52836_SHARP_){
return cljs.core._EQ_.call(null,workplace_id,new cljs.core.Keyword("worker","workplace","worker/workplace",-1450573153).cljs$core$IFn$_invoke$arity$1(p1__52836_SHARP_));
});})(vec__52838,_,workplace_id))
,workers);
}));
re_frame.core.reg_sub.call(null,new cljs.core.Keyword("workers","by-id","workers/by-id",-30752208),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("workers","list","workers/list",-759802960)], null),(function (workers,p__52842){
var vec__52843 = p__52842;
var _ = cljs.core.nth.call(null,vec__52843,(0),null);
var worker_id = cljs.core.nth.call(null,vec__52843,(1),null);
return cljs.core.first.call(null,cljs.core.filter.call(null,((function (vec__52843,_,worker_id){
return (function (p1__52841_SHARP_){
return cljs.core._EQ_.call(null,worker_id,new cljs.core.Keyword("mongo","object-id","mongo/object-id",-1464142663).cljs$core$IFn$_invoke$arity$1(p1__52841_SHARP_));
});})(vec__52843,_,worker_id))
,workers));
}));
...
//# sourceMappingURL=subs.js.map?rel=1508962664377
