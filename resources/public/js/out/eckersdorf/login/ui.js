...
goog.provide('eckersdorf.login.ui');
...
eckersdorf.login.ui.login_form = (function eckersdorf$login$ui$login_form(){
...
return (function (e){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("login","set-email-address!","login/set-email-address!",-845735511),e.target.value], null));
...
return (function (e){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("login","set-password!","login/set-password!",764014747),e.target.value], null));
});})(form,invalid_password_QMARK_))
