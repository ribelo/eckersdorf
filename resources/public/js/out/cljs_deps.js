...
goog.addDependency("../eckersdorf/view/ui.js", ['eckersdorf.view.ui'], ['eckersdorf.workers.ui', 'reagent.ratom', 'goog.string', 'reagent.core', 'cljs.core', 'antizer.reagent', 'eckersdorf.flex', 'eckersdorf.routes.core', 'cljs.spec.alpha', 'eckersdorf.user.login.ui', 'eckersdorf.workplaces.ui', 're_frame.core', 'cuerdas.core']);
...
goog.addDependency("../eckersdorf/db/events.js", ['eckersdorf.db.events'], ['eckersdorf.user.db', 'cljs.core', 'eckersdorf.workers.db', 'cljs_time.core', 'eckersdorf.user.login.db', 'eckersdorf.view.db', 'eckersdorf.db.core', 'eckersdorf.workplaces.db', 'eckersdorf.window.db', 'eckersdorf.process.db', 'eckersdorf.error.db', 're_frame.core']);
...
goog.addDependency("../eckersdorf/init.js", ['eckersdorf.init'], ['eckersdorf.view.subs', 'eckersdorf.window.events', 'eckersdorf.user.db', 'eckersdorf.process.subs', 'eckersdorf.user.login.subs', 'eckersdorf.window.subs', 'eckersdorf.routes.events', 're_frame.registrar', 'cljs.core', 'eckersdorf.workers.db', 'eckersdorf.error.events', 'eckersdorf.user.subs', 'eckersdorf.user.events', 'eckersdorf.db.specs', 'eckersdorf.workplaces.events', 're_frame.router', 'antizer.reagent', 'eckersdorf.user.login.db', 're_frame.loggers', 'eckersdorf.user.login.events', 'eckersdorf.view.events', 'eckersdorf.workplaces.db', 'eckersdorf.workplaces.subs', 'eckersdorf.process.events', 'eckersdorf.error.subs', 'eckersdorf.workers.events', 'eckersdorf.db.events', 'taoensso.timbre', 'eckersdorf.routes.core', 'eckersdorf.events', 'eckersdorf.workers.subs', 'eckersdorf.window.db', 'eckersdorf.process.db', 'eckersdorf.error.db', 'day8.re_frame.http_fx']);
