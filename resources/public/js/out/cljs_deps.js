...
goog.addDependency("../eckersdorf/view/ui.js", ['eckersdorf.view.ui'], ['reagent.ratom', 'goog.string', 'reagent.core', 'cljs.core', 'eckersdorf.util', 'antizer.reagent', 'eckersdorf.flex', 'eckersdorf.routes.core', 'eckersdorf.user.login.ui', 're_frame.core', 'cuerdas.core']);
...
goog.addDependency("../eckersdorf/db/events.js", ['eckersdorf.db.events'], ['eckersdorf.user.db', 'cljs.core', 'eckersdorf.user.login.db', 'eckersdorf.view.db', 'eckersdorf.db.core', 'eckersdorf.window.db', 'eckersdorf.process.db', 'eckersdorf.error.db', 're_frame.core']);
...
goog.addDependency("../eckersdorf/init.js", ['eckersdorf.init'], ['eckersdorf.view.subs', 'eckersdorf.window.events', 'eckersdorf.user.db', 'eckersdorf.process.subs', 'eckersdorf.user.login.subs', 'eckersdorf.window.subs', 'eckersdorf.routes.events', 're_frame.registrar', 'cljs.core', 'eckersdorf.error.events', 'eckersdorf.user.subs', 'eckersdorf.user.events', 'eckersdorf.db.specs', 're_frame.router', 'eckersdorf.user.login.db', 're_frame.loggers', 'eckersdorf.user.login.events', 'eckersdorf.view.events', 'eckersdorf.process.events', 'eckersdorf.error.subs', 'eckersdorf.db.events', 'taoensso.timbre', 'eckersdorf.routes.core', 'eckersdorf.events', 'eckersdorf.window.db', 'eckersdorf.process.db', 'eckersdorf.error.db', 'day8.re_frame.http_fx']);
