...
var G__41875 = format;
var G__41875__$1 = (((G__41875 instanceof cljs.core.Keyword))?G__41875.fqn:null);
switch (G__41875__$1) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__41879_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__41879_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__41880){
...
var handler = cljs.core.get.call(null,map__41881__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__41881__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__41881__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__41881,map__41881__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__41883){
var vec__41884 = p__41883;
var ok = cljs.core.nth.call(null,vec__41884,(0),null);
var result = cljs.core.nth.call(null,vec__41884,(1),null);
...
;})(h,e,map__41881,map__41881__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__41887){
...
var opts = map__41888__$1;
var method = cljs.core.get.call(null,map__41888__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__41888__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__41888__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__41888__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__41888__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
...
//# sourceMappingURL=easy.js.map?rel=1506985650398
