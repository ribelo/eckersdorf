...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__41863){
var map__41864 = p__41863;
var map__41864__$1 = ((((!((map__41864 == null)))?((((map__41864.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41864.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41864):map__41864);
var handler = cljs.core.get.call(null,map__41864__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__30249__auto__ = p1__41866_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__41867){
var map__41868 = p__41867;
var map__41868__$1 = ((((!((map__41868 == null)))?((((map__41868.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41868.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41868):map__41868);
var request = map__41868__$1;
var interceptors = cljs.core.get.call(null,map__41868__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__30249__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__30249__auto__)){
return or__30249__auto__;
} else {
...
//# sourceMappingURL=simple.js.map?rel=1506985650366
