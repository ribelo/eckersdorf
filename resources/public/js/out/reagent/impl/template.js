...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30920__auto__,writer__30921__auto__,opt__30922__auto__){
return cljs.core._write.call(null,writer__30921__auto__,"reagent.impl.template/NativeWrapper");
});
...
var temp__5292__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var k_SINGLEQUOTE_ = temp__5292__auto__;
...
var G__50096 = o;
(G__50096[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var temp__5292__auto__ = (id_class["className"]);
if((temp__5292__auto__ == null)){
return p__$1;
} else {
var class$ = temp__5292__auto__;
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__50101){
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50104){
...
var on_write = cljs.core.get.call(null,map__50105__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__50105,map__50105__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__50105,map__50105__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__50110){
var map__50111 = p__50110;
var map__50111__$1 = ((((!((map__50111 == null)))?((((map__50111.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50111.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50111):map__50111);
var synthetic_on_update = cljs.core.get.call(null,map__50111__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__50111__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
if(cljs.core.truth_((function (){var and__30237__auto__ = !((jsprops == null));
if(and__30237__auto__){
var and__30237__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__50113 = jsprops;
(G__50113["defaultValue"] = value);

(G__50113["onChange"] = ((function (G__50113,v,value,on_change,on_change__$1,map__50111,map__50111__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__50107_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__50107_SHARP_);
});})(G__50113,v,value,on_change,on_change__$1,map__50111,map__50111__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__50117 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__50117,(0),null);
var id = cljs.core.nth.call(null,vec__50117,(1),null);
var class$ = cljs.core.nth.call(null,vec__50117,(2),null);
...
var temp__5292__auto__ = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
if((temp__5292__auto__ == null)){
return reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null));
} else {
var k = temp__5292__auto__;
return k;
}
});
...
var jsprops = ({"argv": v});
var temp__5294__auto___50121 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5294__auto___50121 == null)){
} else {
var key_50122 = temp__5294__auto___50121;
(jsprops["key"] = key_50122);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__50125){
var map__50126 = p__50125;
var map__50126__$1 = ((((!((map__50126 == null)))?((((map__50126.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50126.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50126):map__50126);
var synthetic_input = cljs.core.get.call(null,map__50126__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__50128 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__50128["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__50129 = wrapped;
(G__50129["syntheticInput"] = true);

return G__50129;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__50130 = wrapped__$1;
(G__50130["syntheticOnChange"] = on_change);

return G__50130;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__50131 = wrapped__$2;
(G__50131["syntheticOnUpdate"] = on_update);
...
var temp__5292__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__5292__auto__ == null)){
return (reagent.impl.template.tag_name_cache[x] = reagent.impl.template.parse_tag.call(null,x));
} else {
var s = temp__5292__auto__;
return s;
}
});
...
if(cljs.core.truth_((function (){var or__30249__auto__ = synthetic_input;
...
var len__31526__auto___50137 = arguments.length;
var i__31527__auto___50138 = (0);
while(true){
if((i__31527__auto___50138 < len__31526__auto___50137)){
args__31533__auto__.push((arguments[i__31527__auto___50138]));

var G__50139 = (i__31527__auto___50138 + (1));
i__31527__auto___50138 = G__50139;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31534__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50135){
var G__50136 = cljs.core.first.call(null,seq50135);
var seq50135__$1 = cljs.core.next.call(null,seq50135);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__50136,seq50135__$1);
});
...
break;
default:
var G__50142 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__50142;
continue;
...
var n__31292__auto___50144 = a.length;
var i_50145 = (0);
while(true){
if((i_50145 < n__31292__auto___50144)){
(a[i_50145] = reagent.impl.template.as_element.call(null,(a[i_50145])));

var G__50146 = (i_50145 + (1));
i_50145 = G__50146;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31292__auto___50147 = a.length;
var i_50148 = (0);
while(true){
if((i_50148 < n__31292__auto___50147)){
var val_50149 = (a[i_50148]);
if((cljs.core.vector_QMARK_.call(null,val_50149)) && ((reagent.impl.template.key_from_vec.call(null,val_50149) == null))){
(o["no-key"] = true);
} else {
}

(a[i_50148] = reagent.impl.template.as_element.call(null,val_50149));

var G__50150 = (i_50148 + (1));
i_50148 = G__50150;
continue;
} else {
}
...
var ctx = ({});
var vec__50151 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__50151,(0),null);
var derefed = cljs.core.nth.call(null,vec__50151,(1),null);
...
var G__50154 = (cljs.core.count.call(null,argv) - first_child);
switch (G__50154) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__50154){
...
//# sourceMappingURL=template.js.map?rel=1509397951401
