...
var G__52549 = o;
(G__52549[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__52554){
var map__52555 = p__52554;
var map__52555__$1 = ((((!((map__52555 == null)))?((((map__52555.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52555.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52555):map__52555);
var props = map__52555__$1;
var class$ = cljs.core.get.call(null,map__52555__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__52557){
...
var on_write = cljs.core.get.call(null,map__52558__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__52558,map__52558__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__52558,map__52558__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__52563){
var map__52564 = p__52563;
var map__52564__$1 = ((((!((map__52564 == null)))?((((map__52564.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52564.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52564):map__52564);
var synthetic_on_update = cljs.core.get.call(null,map__52564__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__52564__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
if(cljs.core.truth_((function (){var and__30510__auto__ = !((jsprops == null));
if(and__30510__auto__){
var and__30510__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__52566 = jsprops;
(G__52566["defaultValue"] = value);

(G__52566["onChange"] = ((function (G__52566,v,value,on_change,on_change__$1,map__52564,map__52564__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__52560_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__52560_SHARP_);
});})(G__52566,v,value,on_change,on_change__$1,map__52564,map__52564__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__52570 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__52570,(0),null);
var id = cljs.core.nth.call(null,vec__52570,(1),null);
var class$ = cljs.core.nth.call(null,vec__52570,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___52574 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___52574 == null)){
} else {
var key_52575 = temp__5461__auto___52574;
(jsprops["key"] = key_52575);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__52578){
...
var synthetic_input = cljs.core.get.call(null,map__52579__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__52581 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__52581["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__52582 = wrapped;
(G__52582["syntheticInput"] = true);

return G__52582;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__52583 = wrapped__$1;
(G__52583["syntheticOnChange"] = on_change);

return G__52583;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__52584 = wrapped__$2;
(G__52584["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__30522__auto__ = synthetic_input;
...
var len__31802__auto___52590 = arguments.length;
var i__31803__auto___52591 = (0);
while(true){
if((i__31803__auto___52591 < len__31802__auto___52590)){
args__31809__auto__.push((arguments[i__31803__auto___52591]));

var G__52592 = (i__31803__auto___52591 + (1));
i__31803__auto___52591 = G__52592;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq52588){
var G__52589 = cljs.core.first.call(null,seq52588);
var seq52588__$1 = cljs.core.next.call(null,seq52588);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__52589,seq52588__$1);
});
...
break;
default:
var G__52595 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__52595;
continue;
...
var n__31568__auto___52597 = a.length;
var i_52598 = (0);
while(true){
if((i_52598 < n__31568__auto___52597)){
(a[i_52598] = reagent.impl.template.as_element.call(null,(a[i_52598])));

var G__52599 = (i_52598 + (1));
i_52598 = G__52599;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31568__auto___52600 = a.length;
var i_52601 = (0);
while(true){
if((i_52601 < n__31568__auto___52600)){
var val_52602 = (a[i_52601]);
if((cljs.core.vector_QMARK_.call(null,val_52602)) && ((reagent.impl.template.key_from_vec.call(null,val_52602) == null))){
(o["no-key"] = true);
} else {
}

(a[i_52601] = reagent.impl.template.as_element.call(null,val_52602));
...
var ctx = ({});
var vec__52604 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__52604,(0),null);
var derefed = cljs.core.nth.call(null,vec__52604,(1),null);
...
var G__52607 = (cljs.core.count.call(null,argv) - first_child);
switch (G__52607) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__52607){
...
//# sourceMappingURL=template.js.map?rel=1510703509390
