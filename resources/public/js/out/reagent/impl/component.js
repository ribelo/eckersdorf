...
if((i < len)){
var k = (ks[i]);
var G__50052 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__50053 = (i + (1));
m = G__50052;
i = G__50053;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__50055 = c;
var G__50055__$1 = (((G__50055 == null))?null:G__50055.prototype);
if((G__50055__$1 == null)){
return null;
} else {
return (G__50055__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__50057 = c;
var G__50057__$1 = (((G__50057 == null))?null:G__50057.prototype);
if((G__50057__$1 == null)){
return null;
} else {
return (G__50057__$1["render"]);
}
})() == null)));
});
...
return (function() { 
var G__50060__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__50060 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50061__i = 0, G__50061__a = new Array(arguments.length -  0);
while (G__50061__i < G__50061__a.length) {G__50061__a[G__50061__i] = arguments[G__50061__i + 0]; ++G__50061__i;}
  args = new cljs.core.IndexedSeq(G__50061__a,0,null);
} 
return G__50060__delegate.call(this,args);};
G__50060.cljs$lang$maxFixedArity = 0;
G__50060.cljs$lang$applyTo = (function (arglist__50062){
var args = cljs.core.seq(arglist__50062);
return G__50060__delegate(args);
});
...
var _STAR_current_component_STAR_50064 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_50064;
}});
...
return ((function (G__50065,G__50065__$1){
...
var or__30249__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__50066_50068 = (c["cljsRatom"]);
if((G__50066_50068 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__50066_50068);
}
...
if(cljs.core.truth_((function (){var and__30237__auto__ = wrap;
...
var renders_50070 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_50071 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_50070));
if((cljs.core.count.call(null,renders_50070) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_50070))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_50071)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_50071))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__30249__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__30249__auto__)){
return or__30249__auto__;
} else {
...
var render_fun__$1 = (function (){var or__30249__auto__ = render_fun;
if(cljs.core.truth_(or__30249__auto__)){
return or__30249__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30249__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__30249__auto__)){
return or__30249__auto__;
} else {
...
var name__$1 = (function (){var G__50069 = name;
switch (G__50069) {
case "":
...
var G__50073 = o;
(G__50073[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__50074 = fiber;
var G__50074__$1 = (((G__50074 == null))?null:(G__50074["type"]));
if((G__50074__$1 == null)){
return null;
} else {
return (G__50074__$1["displayName"]);
}
})();
var parent = (function (){var G__50075 = fiber;
if((G__50075 == null)){
return null;
} else {
return (G__50075["return"]);
}
})();
var path = (function (){var G__50076 = parent;
var G__50076__$1 = (((G__50076 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__50076));
if((G__50076__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50076__$1)," > "].join('');
}
})();
...
var temp__5288__auto__ = (function (){var G__50077 = c;
if((G__50077 == null)){
return null;
} else {
return (G__50077["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(temp__5288__auto__)){
var fiber = temp__5288__auto__;
return reagent.impl.component.fiber_component_path.call(null,fiber);
} else {
var elem = (function (){var G__50078 = (function (){var or__30249__auto__ = (function (){var G__50080 = c;
if((G__50080 == null)){
return null;
} else {
return (G__50080["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__30249__auto__)){
return or__30249__auto__;
...
return (G__50078["_currentElement"]);
}
})();
var name = (function (){var G__50081 = elem;
var G__50081__$1 = (((G__50081 == null))?null:(G__50081["type"]));
if((G__50081__$1 == null)){
return null;
} else {
return (G__50081__$1["displayName"]);
}
})();
var path = (function (){var G__50082 = elem;
var G__50082__$1 = (((G__50082 == null))?null:(G__50082["_owner"]));
var G__50082__$2 = (((G__50082__$1 == null))?null:reagent.impl.component.component_path.call(null,G__50082__$1));
if((G__50082__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50082__$2)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__50083 = c;
var G__50083__$1 = (((G__50083 == null))?null:G__50083.constructor);
if((G__50083__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__50083__$1);
}
}
})();
...
var temp__5292__auto__ = reagent.impl.component.cached_react_class.call(null,tag);
if((temp__5292__auto__ == null)){
...
//# sourceMappingURL=component.js.map?rel=1509397951294
