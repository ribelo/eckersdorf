...
var or__30523__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj48676 = {"detail":data};
return obj48676;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30511__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30511__auto__)){
var and__30511__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__48683 = cljs.core._EQ_;
var expr__48684 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__48683.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__48684))){
return ((function (pred__48683,expr__48684){
return (function (p1__48677_SHARP_){
return console.warn(p1__48677_SHARP_);
});
;})(pred__48683,expr__48684))
} else {
if(cljs.core.truth_(pred__48683.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__48684))){
return ((function (pred__48683,expr__48684){
return (function (p1__48678_SHARP_){
return console.debug(p1__48678_SHARP_);
});
;})(pred__48683,expr__48684))
} else {
if(cljs.core.truth_(pred__48683.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__48684))){
return ((function (pred__48683,expr__48684){
return (function (p1__48679_SHARP_){
return console.error(p1__48679_SHARP_);
});
;})(pred__48683,expr__48684))
} else {
return ((function (pred__48683,expr__48684){
return (function (p1__48680_SHARP_){
return console.log(p1__48680_SHARP_);
});
;})(pred__48683,expr__48684))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__48687){
...
var opts = map__48688__$1;
var eval_fn = cljs.core.get.call(null,map__48688__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__48690_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__48692,(0),null);
var v = cljs.core.nth.call(null,vec__48692,(1),null);
...
if(cljs.core.truth_((function (){var and__30511__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1510609301792
