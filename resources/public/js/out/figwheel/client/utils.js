...
return (new CustomEvent(event_name,(function (){var obj48954 = {"detail":data};
return obj48954;
})()));
} else {
...
var f = (function (){var pred__48961 = cljs.core._EQ_;
var expr__48962 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__48961.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__48962))){
return ((function (pred__48961,expr__48962){
return (function (p1__48955_SHARP_){
return console.warn(p1__48955_SHARP_);
});
;})(pred__48961,expr__48962))
} else {
if(cljs.core.truth_(pred__48961.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__48962))){
return ((function (pred__48961,expr__48962){
return (function (p1__48956_SHARP_){
return console.debug(p1__48956_SHARP_);
});
;})(pred__48961,expr__48962))
} else {
if(cljs.core.truth_(pred__48961.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__48962))){
return ((function (pred__48961,expr__48962){
return (function (p1__48957_SHARP_){
return console.error(p1__48957_SHARP_);
});
;})(pred__48961,expr__48962))
} else {
return ((function (pred__48961,expr__48962){
return (function (p1__48958_SHARP_){
return console.log(p1__48958_SHARP_);
});
;})(pred__48961,expr__48962))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__48965){
...
var opts = map__48966__$1;
var eval_fn = cljs.core.get.call(null,map__48966__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__48968_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__48970,(0),null);
var v = cljs.core.nth.call(null,vec__48970,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1506985655078
