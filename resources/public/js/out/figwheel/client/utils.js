...
var or__30522__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj48675 = {"detail":data};
return obj48675;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30510__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30510__auto__)){
var and__30510__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__48682 = cljs.core._EQ_;
var expr__48683 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__48682.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__48683))){
return ((function (pred__48682,expr__48683){
return (function (p1__48676_SHARP_){
return console.warn(p1__48676_SHARP_);
});
;})(pred__48682,expr__48683))
} else {
if(cljs.core.truth_(pred__48682.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__48683))){
return ((function (pred__48682,expr__48683){
return (function (p1__48677_SHARP_){
return console.debug(p1__48677_SHARP_);
});
;})(pred__48682,expr__48683))
} else {
if(cljs.core.truth_(pred__48682.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__48683))){
return ((function (pred__48682,expr__48683){
return (function (p1__48678_SHARP_){
return console.error(p1__48678_SHARP_);
});
;})(pred__48682,expr__48683))
} else {
return ((function (pred__48682,expr__48683){
return (function (p1__48679_SHARP_){
return console.log(p1__48679_SHARP_);
});
;})(pred__48682,expr__48683))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__48686){
var map__48687 = p__48686;
...
var opts = map__48687__$1;
var eval_fn = cljs.core.get.call(null,map__48687__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__48689_SHARP_);
});})(new_def))
);
...
return (function (p__48690){
var vec__48691 = p__48690;
var ky = cljs.core.nth.call(null,vec__48691,(0),null);
var v = cljs.core.nth.call(null,vec__48691,(1),null);
...
if(cljs.core.truth_((function (){var and__30510__auto__ = typeof localStorage !== 'undefined';
...
}catch (e48696){if((e48696 instanceof Error)){
var e = e48696;
return not_found;
} else {
throw e48696;
...
//# sourceMappingURL=utils.js.map?rel=1510602155305
