...
var or__30249__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj53141 = {"detail":data};
return obj53141;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30237__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30237__auto__)){
var and__30237__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__53148 = cljs.core._EQ_;
var expr__53149 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__53148.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__53149))){
return ((function (pred__53148,expr__53149){
return (function (p1__53142_SHARP_){
return console.warn(p1__53142_SHARP_);
});
;})(pred__53148,expr__53149))
} else {
if(cljs.core.truth_(pred__53148.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__53149))){
return ((function (pred__53148,expr__53149){
return (function (p1__53143_SHARP_){
return console.debug(p1__53143_SHARP_);
});
;})(pred__53148,expr__53149))
} else {
if(cljs.core.truth_(pred__53148.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__53149))){
return ((function (pred__53148,expr__53149){
return (function (p1__53144_SHARP_){
return console.error(p1__53144_SHARP_);
});
;})(pred__53148,expr__53149))
} else {
return ((function (pred__53148,expr__53149){
return (function (p1__53145_SHARP_){
return console.log(p1__53145_SHARP_);
});
;})(pred__53148,expr__53149))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__53152){
var map__53153 = p__53152;
var map__53153__$1 = ((((!((map__53153 == null)))?((((map__53153.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53153.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53153):map__53153);
var opts = map__53153__$1;
var eval_fn = cljs.core.get.call(null,map__53153__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__53155_SHARP_);
});})(new_def))
);
...
return (function (p__53156){
var vec__53157 = p__53156;
var ky = cljs.core.nth.call(null,vec__53157,(0),null);
var v = cljs.core.nth.call(null,vec__53157,(1),null);
...
if(cljs.core.truth_((function (){var and__30237__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1507056182921
