...
return (new CustomEvent(event_name,(function (){var obj48678 = {"detail":data};
return obj48678;
})()));
} else {
...
var f = (function (){var pred__48685 = cljs.core._EQ_;
var expr__48686 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__48685.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__48686))){
return ((function (pred__48685,expr__48686){
return (function (p1__48679_SHARP_){
return console.warn(p1__48679_SHARP_);
});
;})(pred__48685,expr__48686))
} else {
if(cljs.core.truth_(pred__48685.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__48686))){
return ((function (pred__48685,expr__48686){
return (function (p1__48680_SHARP_){
return console.debug(p1__48680_SHARP_);
});
;})(pred__48685,expr__48686))
} else {
if(cljs.core.truth_(pred__48685.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__48686))){
return ((function (pred__48685,expr__48686){
return (function (p1__48681_SHARP_){
return console.error(p1__48681_SHARP_);
});
;})(pred__48685,expr__48686))
} else {
return ((function (pred__48685,expr__48686){
return (function (p1__48682_SHARP_){
return console.log(p1__48682_SHARP_);
});
;})(pred__48685,expr__48686))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__48689){
...
var opts = map__48690__$1;
var eval_fn = cljs.core.get.call(null,map__48690__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__48692_SHARP_);
});})(new_def))
);
...
return (function (p__48693){
var vec__48694 = p__48693;
var ky = cljs.core.nth.call(null,vec__48694,(0),null);
...
}catch (e48699){if((e48699 instanceof Error)){
var e = e48699;
return not_found;
} else {
throw e48699;
...
//# sourceMappingURL=utils.js.map?rel=1510703505628
