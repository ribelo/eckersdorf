...
return (new CustomEvent(event_name,(function (){var obj47906 = {"detail":data};
return obj47906;
})()));
} else {
...
var f = (function (){var pred__47913 = cljs.core._EQ_;
var expr__47914 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__47913.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__47914))){
return ((function (pred__47913,expr__47914){
return (function (p1__47907_SHARP_){
return console.warn(p1__47907_SHARP_);
});
;})(pred__47913,expr__47914))
} else {
if(cljs.core.truth_(pred__47913.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__47914))){
return ((function (pred__47913,expr__47914){
return (function (p1__47908_SHARP_){
return console.debug(p1__47908_SHARP_);
});
;})(pred__47913,expr__47914))
} else {
if(cljs.core.truth_(pred__47913.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__47914))){
return ((function (pred__47913,expr__47914){
return (function (p1__47909_SHARP_){
return console.error(p1__47909_SHARP_);
});
;})(pred__47913,expr__47914))
} else {
return ((function (pred__47913,expr__47914){
return (function (p1__47910_SHARP_){
return console.log(p1__47910_SHARP_);
});
;})(pred__47913,expr__47914))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__47917){
...
var opts = map__47918__$1;
var eval_fn = cljs.core.get.call(null,map__47918__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__47920_SHARP_){
return new_def.callback(p1__47920_SHARP_);
});})(new_def))
);
...
return (function (p__47921){
var vec__47922 = p__47921;
var ky = cljs.core.nth.call(null,vec__47922,(0),null);
...
}catch (e47927){if((e47927 instanceof Error)){
var e = e47927;
return not_found;
} else {
throw e47927;
...
//# sourceMappingURL=utils.js.map?rel=1509397949395
