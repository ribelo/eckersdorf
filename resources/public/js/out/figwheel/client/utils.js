...
var or__30239__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj48944 = {"detail":data};
return obj48944;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30227__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30227__auto__)){
var and__30227__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__48951 = cljs.core._EQ_;
var expr__48952 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__48951.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__48952))){
return ((function (pred__48951,expr__48952){
return (function (p1__48945_SHARP_){
return console.warn(p1__48945_SHARP_);
});
;})(pred__48951,expr__48952))
} else {
if(cljs.core.truth_(pred__48951.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__48952))){
return ((function (pred__48951,expr__48952){
return (function (p1__48946_SHARP_){
return console.debug(p1__48946_SHARP_);
});
;})(pred__48951,expr__48952))
} else {
if(cljs.core.truth_(pred__48951.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__48952))){
return ((function (pred__48951,expr__48952){
return (function (p1__48947_SHARP_){
return console.error(p1__48947_SHARP_);
});
;})(pred__48951,expr__48952))
} else {
return ((function (pred__48951,expr__48952){
return (function (p1__48948_SHARP_){
return console.log(p1__48948_SHARP_);
});
;})(pred__48951,expr__48952))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__48955){
...
var opts = map__48956__$1;
var eval_fn = cljs.core.get.call(null,map__48956__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__48958_SHARP_);
});})(new_def))
);
...
return (function (p__48959){
var vec__48960 = p__48959;
var ky = cljs.core.nth.call(null,vec__48960,(0),null);
var v = cljs.core.nth.call(null,vec__48960,(1),null);
...
if(cljs.core.truth_((function (){var and__30227__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1507757468132
