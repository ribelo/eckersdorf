...
return (new CustomEvent(event_name,(function (){var obj41132 = {"detail":data};
return obj41132;
})()));
} else {
...
var f = (function (){var pred__41139 = cljs.core._EQ_;
var expr__41140 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__41139.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__41140))){
return ((function (pred__41139,expr__41140){
return (function (p1__41133_SHARP_){
return console.warn(p1__41133_SHARP_);
});
;})(pred__41139,expr__41140))
} else {
if(cljs.core.truth_(pred__41139.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__41140))){
return ((function (pred__41139,expr__41140){
return (function (p1__41134_SHARP_){
return console.debug(p1__41134_SHARP_);
});
;})(pred__41139,expr__41140))
} else {
if(cljs.core.truth_(pred__41139.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__41140))){
return ((function (pred__41139,expr__41140){
return (function (p1__41135_SHARP_){
return console.error(p1__41135_SHARP_);
});
;})(pred__41139,expr__41140))
} else {
return ((function (pred__41139,expr__41140){
return (function (p1__41136_SHARP_){
return console.log(p1__41136_SHARP_);
});
;})(pred__41139,expr__41140))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__41143){
...
var eval_fn = cljs.core.get.call(null,map__41144__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__41146_SHARP_){
return new_def.callback(p1__41146_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__41148,(0),null);
var v = cljs.core.nth.call(null,vec__41148,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1506023648260
