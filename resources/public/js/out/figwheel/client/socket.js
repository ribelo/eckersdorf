...
}catch (e50198){if((e50198 instanceof Error)){
var e = e50198;
return null;
} else {
throw e50198;
...
var and__30227__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__30227__auto__){
var and__30227__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__30227__auto____$1)){
var and__30227__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__50199){
var map__50200 = p__50199;
var map__50200__$1 = ((((!((map__50200 == null)))?((((map__50200.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50200.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50200):map__50200);
var opts = map__50200__$1;
var retry_count = cljs.core.get.call(null,map__50200__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__50200__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__50200__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__50200__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var temp__5288__auto__ = figwheel.client.socket.get_websocket_imp.call(null);
if(cljs.core.truth_(temp__5288__auto__)){
var WebSocket = temp__5288__auto__;
...
socket.onmessage = ((function (url,socket,WebSocket,temp__5288__auto__,map__50200,map__50200__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (msg_str){
var temp__5290__auto__ = cljs.reader.read_string.call(null,msg_str.data);
...
});})(url,socket,WebSocket,temp__5288__auto__,map__50200,map__50200__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__5288__auto__,map__50200,map__50200__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__5288__auto__,map__50200,map__50200__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__30239__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5288__auto__,map__50200,map__50200__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5288__auto__,map__50200,map__50200__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__30598__auto__ = (10000);
var y__30599__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__5288__auto__,map__50200,map__50200__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1509094253206
