...
var vec__39391_39394 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_39395 = cljs.core.nth.call(null,vec__39391_39394,(0),null);
var only_after_39396 = cljs.core.nth.call(null,vec__39391_39394,(1),null);
var db_changed_QMARK__39397 = (!((only_before_39395 == null))) || (!((only_after_39396 == null)));
if(db_changed_QMARK__39397){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_39395);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_39396);
...
var map__39398 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__39398__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__39398__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__39400 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__39400__$1;
var event = cljs.core.get.call(null,map__39400__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__31516__auto___39403 = arguments.length;
var i__31517__auto___39404 = (0);
while(true){
if((i__31517__auto___39404 < len__31516__auto___39403)){
args__31523__auto__.push((arguments[i__31517__auto___39404]));

var G__39405 = (i__31517__auto___39404 + (1));
i__31517__auto___39404 = G__39405;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq39402){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39402));
});
...
var args__31523__auto__ = [];
var len__31516__auto___39411 = arguments.length;
var i__31517__auto___39412 = (0);
while(true){
if((i__31517__auto___39412 < len__31516__auto___39411)){
args__31523__auto__.push((arguments[i__31517__auto___39412]));

var G__39413 = (i__31517__auto___39412 + (1));
i__31517__auto___39412 = G__39413;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__39406_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__39407_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__39407_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq39408){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__39409,G__39410,seq39408__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1507757452471
