...
var vec__33877_33880 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_33881 = cljs.core.nth.call(null,vec__33877_33880,(0),null);
var only_after_33882 = cljs.core.nth.call(null,vec__33877_33880,(1),null);
var db_changed_QMARK__33883 = (!((only_before_33881 == null))) || (!((only_after_33882 == null)));
if(db_changed_QMARK__33883){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_33881);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_33882);
...
var map__33884 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__33884__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__33884__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__33886 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__33886__$1;
var event = cljs.core.get.call(null,map__33886__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__31516__auto___33889 = arguments.length;
var i__31517__auto___33890 = (0);
while(true){
if((i__31517__auto___33890 < len__31516__auto___33889)){
args__31523__auto__.push((arguments[i__31517__auto___33890]));

var G__33891 = (i__31517__auto___33890 + (1));
i__31517__auto___33890 = G__33891;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__31524__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq33888){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33888));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__30239__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__31523__auto__ = [];
var len__31516__auto___33897 = arguments.length;
var i__31517__auto___33898 = (0);
while(true){
if((i__31517__auto___33898 < len__31516__auto___33897)){
args__31523__auto__.push((arguments[i__31517__auto___33898]));

var G__33899 = (i__31517__auto___33898 + (1));
i__31517__auto___33898 = G__33899;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31524__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__33892_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__33893_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__33893_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__30227__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq33894){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__33895,G__33896,seq33894__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1509094235154
