...
var vec__33832_33835 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_33836 = cljs.core.nth.call(null,vec__33832_33835,(0),null);
var only_after_33837 = cljs.core.nth.call(null,vec__33832_33835,(1),null);
var db_changed_QMARK__33838 = (!((only_before_33836 == null))) || (!((only_after_33837 == null)));
if(db_changed_QMARK__33838){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_33836);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_33837);
...
var map__33839 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__33839__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__33839__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__33841 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__33841__$1;
var event = cljs.core.get.call(null,map__33841__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__31526__auto___33844 = arguments.length;
var i__31527__auto___33845 = (0);
while(true){
if((i__31527__auto___33845 < len__31526__auto___33844)){
args__31533__auto__.push((arguments[i__31527__auto___33845]));

var G__33846 = (i__31527__auto___33845 + (1));
i__31527__auto___33845 = G__33846;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq33843){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33843));
});
...
var args__31533__auto__ = [];
var len__31526__auto___33852 = arguments.length;
var i__31527__auto___33853 = (0);
while(true){
if((i__31527__auto___33853 < len__31526__auto___33852)){
args__31533__auto__.push((arguments[i__31527__auto___33853]));

var G__33854 = (i__31527__auto___33853 + (1));
i__31527__auto___33853 = G__33854;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__33847_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__33848_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__33848_SHARP_);
...
var G__33851 = cljs.core.first.call(null,seq33849__$1);
var seq33849__$2 = cljs.core.next.call(null,seq33849__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__33850,G__33851,seq33849__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1506023156942
