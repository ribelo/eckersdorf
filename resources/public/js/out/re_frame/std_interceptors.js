...
var vec__39155_39158 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_39159 = cljs.core.nth.call(null,vec__39155_39158,(0),null);
var only_after_39160 = cljs.core.nth.call(null,vec__39155_39158,(1),null);
var db_changed_QMARK__39161 = (!((only_before_39159 == null))) || (!((only_after_39160 == null)));
if(db_changed_QMARK__39161){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_39159);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_39160);
...
var map__39162 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__39162__$1 = ((((!((map__39162 == null)))?((((map__39162.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39162.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39162):map__39162);
var db = cljs.core.get.call(null,map__39162__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__39162__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__39164 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__39164__$1;
var event = cljs.core.get.call(null,map__39164__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__31526__auto___39167 = arguments.length;
var i__31527__auto___39168 = (0);
while(true){
if((i__31527__auto___39168 < len__31526__auto___39167)){
args__31533__auto__.push((arguments[i__31527__auto___39168]));

var G__39169 = (i__31527__auto___39168 + (1));
i__31527__auto___39168 = G__39169;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__31534__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq39166){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39166));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__30249__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__31533__auto__ = [];
var len__31526__auto___39175 = arguments.length;
var i__31527__auto___39176 = (0);
while(true){
if((i__31527__auto___39176 < len__31526__auto___39175)){
args__31533__auto__.push((arguments[i__31527__auto___39176]));

var G__39177 = (i__31527__auto___39176 + (1));
i__31527__auto___39176 = G__39177;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31534__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__39170_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__39171_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__39171_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__30237__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq39172){
var G__39173 = cljs.core.first.call(null,seq39172);
var seq39172__$1 = cljs.core.next.call(null,seq39172);
var G__39174 = cljs.core.first.call(null,seq39172__$1);
var seq39172__$2 = cljs.core.next.call(null,seq39172__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__39173,G__39174,seq39172__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1506985647967
