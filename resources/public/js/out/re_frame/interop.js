...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__33446 = cljs.core.instance_QMARK_;
var expr__33447 = reactive_val;
if(cljs.core.truth_(pred__33446.call(null,reagent.ratom.RAtom,expr__33447))){
return "ra";
} else {
if(cljs.core.truth_(pred__33446.call(null,reagent.ratom.RCursor,expr__33447))){
return "rc";
} else {
if(cljs.core.truth_(pred__33446.call(null,reagent.ratom.Reaction,expr__33447))){
return "rx";
} else {
if(cljs.core.truth_(pred__33446.call(null,reagent.ratom.Track,expr__33447))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1509094234193
