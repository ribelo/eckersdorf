...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__52706 = cljs.core.instance_QMARK_;
var expr__52707 = reactive_val;
if(cljs.core.truth_(pred__52706.call(null,reagent.ratom.RAtom,expr__52707))){
return "ra";
} else {
if(cljs.core.truth_(pred__52706.call(null,reagent.ratom.RCursor,expr__52707))){
return "rc";
} else {
if(cljs.core.truth_(pred__52706.call(null,reagent.ratom.Reaction,expr__52707))){
return "rx";
} else {
if(cljs.core.truth_(pred__52706.call(null,reagent.ratom.Track,expr__52707))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1510703509548
