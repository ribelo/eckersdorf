...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__50253 = cljs.core.instance_QMARK_;
var expr__50254 = reactive_val;
if(cljs.core.truth_(pred__50253.call(null,reagent.ratom.RAtom,expr__50254))){
return "ra";
} else {
if(cljs.core.truth_(pred__50253.call(null,reagent.ratom.RCursor,expr__50254))){
return "rc";
} else {
if(cljs.core.truth_(pred__50253.call(null,reagent.ratom.Reaction,expr__50254))){
return "rx";
} else {
if(cljs.core.truth_(pred__50253.call(null,reagent.ratom.Track,expr__50254))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1509397951543
