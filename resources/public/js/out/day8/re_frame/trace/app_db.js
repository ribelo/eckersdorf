...
return cljs.core.reduce.call(null,(function (acc,p__53197){
var vec__53198 = p__53197;
var property = cljs.core.nth.call(null,vec__53198,(0),null);
var value = cljs.core.nth.call(null,vec__53198,(1),null);
return cljs.core.assoc.call(null,acc,cljs.core.keyword.call(null,property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__53196_SHARP_){
return clojure.string.split.call(null,p1__53196_SHARP_,/:/);
...
var vec__53201 = jsonml;
var seq__53202 = cljs.core.seq.call(null,vec__53201);
var first__53203 = cljs.core.first.call(null,seq__53202);
var seq__53202__$1 = cljs.core.next.call(null,seq__53202);
var head = first__53203;
var args = seq__53202__$1;
...
var vec__53204 = args;
var seq__53205 = cljs.core.seq.call(null,vec__53204);
var first__53206 = cljs.core.first.call(null,seq__53205);
var seq__53205__$1 = cljs.core.next.call(null,seq__53205);
var style = first__53206;
var children = seq__53205__$1;
...
], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.expansion-button","button.expansion-button",-676095342),(cljs.core.truth_(cljs.core.deref.call(null,expanded_QMARK_))?"\u25BC ":"\u25B6 ")], null)], null),(function (){var or__30522__auto__ = title;
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
} else {
return "data";
}
})(),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),(20)], null)], null),(cljs.core.truth_((function (){var and__30510__auto__ = cljs.core.deref.call(null,expanded_QMARK_);
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.reader.read_string.call(null,["[",cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),"]"].join(''))]),p1__53207_SHARP_);
});})(subtree_input,subtree_paths,input_error))
);
...
return cljs.core.reset_BANG_.call(null,subtree_input,p1__53208_SHARP_.target.value);
});})(subtree_input,subtree_paths,input_error))
...
//# sourceMappingURL=app_db.js.map?rel=1510602166522
