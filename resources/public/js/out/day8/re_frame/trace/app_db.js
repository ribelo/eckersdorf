...
return cljs.core.reduce.call(null,(function (acc,p__53198){
var vec__53199 = p__53198;
var property = cljs.core.nth.call(null,vec__53199,(0),null);
var value = cljs.core.nth.call(null,vec__53199,(1),null);
return cljs.core.assoc.call(null,acc,cljs.core.keyword.call(null,property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__53197_SHARP_){
return clojure.string.split.call(null,p1__53197_SHARP_,/:/);
...
var vec__53202 = jsonml;
var seq__53203 = cljs.core.seq.call(null,vec__53202);
var first__53204 = cljs.core.first.call(null,seq__53203);
var seq__53203__$1 = cljs.core.next.call(null,seq__53203);
var head = first__53204;
var args = seq__53203__$1;
...
var vec__53205 = args;
var seq__53206 = cljs.core.seq.call(null,vec__53205);
var first__53207 = cljs.core.first.call(null,seq__53206);
var seq__53206__$1 = cljs.core.next.call(null,seq__53206);
var style = first__53207;
var children = seq__53206__$1;
...
], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.expansion-button","button.expansion-button",-676095342),(cljs.core.truth_(cljs.core.deref.call(null,expanded_QMARK_))?"\u25BC ":"\u25B6 ")], null)], null),(function (){var or__30523__auto__ = title;
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
return "data";
}
})(),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),(20)], null)], null),(cljs.core.truth_((function (){var and__30511__auto__ = cljs.core.deref.call(null,expanded_QMARK_);
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.reader.read_string.call(null,["[",cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),"]"].join(''))]),p1__53208_SHARP_);
});})(subtree_input,subtree_paths,input_error))
);
...
return cljs.core.reset_BANG_.call(null,subtree_input,p1__53209_SHARP_.target.value);
});})(subtree_input,subtree_paths,input_error))
...
//# sourceMappingURL=app_db.js.map?rel=1510609306463
