...
return cljs.core.filter.call(null,(function (p1__53165_SHARP_){
return cljs.core._EQ_.call(null,type,new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(p1__53165_SHARP_));
}),traces);
});
...
return (function (p__53166,seen__$1){
while(true){
var vec__53167 = p__53166;
var f = cljs.core.nth.call(null,vec__53167,(0),null);
var xs__$1 = vec__53167;
...
var G__53170 = cljs.core.rest.call(null,s);
var G__53171 = seen__$1;
p__53166 = G__53170;
seen__$1 = G__53171;
continue;
} else {
...
var iter__31405__auto__ = (function day8$re_frame$trace$graph$select_links_$_iter__53173(s__53174){
return (new cljs.core.LazySeq(null,(function (){
var s__53174__$1 = s__53174;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__53174__$1);
if(temp__5457__auto__){
var s__53174__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__53174__$2)){
var c__31403__auto__ = cljs.core.chunk_first.call(null,s__53174__$2);
var size__31404__auto__ = cljs.core.count.call(null,c__31403__auto__);
var b__53176 = cljs.core.chunk_buffer.call(null,size__31404__auto__);
if((function (){var i__53175 = (0);
while(true){
if((i__53175 < size__31404__auto__)){
var input_signal = cljs.core._nth.call(null,c__31403__auto__,i__53175);
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__53176),day8$re_frame$trace$graph$select_links_$_iter__53173.call(null,cljs.core.chunk_rest.call(null,s__53174__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__53176),null);
}
} else {
var input_signal = cljs.core.first.call(null,s__53174__$2);
var reaction = day8.re_frame.trace.graph.get_reaction.call(null,trace);
if(cljs.core.every_QMARK_.call(null,cljs.core.some_QMARK_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_signal,reaction], null))){
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"source","source",-433931539),input_signal,new cljs.core.Keyword(null,"target","target",253001721),reaction,new cljs.core.Keyword(null,"value","value",305978217),link_val,new cljs.core.Keyword(null,"id","id",-1388402092),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(input_signal),"|",cljs.core.str.cljs$core$IFn$_invoke$arity$1(reaction)].join('')], null),day8$re_frame$trace$graph$select_links_$_iter__53173.call(null,cljs.core.rest.call(null,s__53174__$2)));
} else {
var G__53179 = cljs.core.rest.call(null,s__53174__$2);
s__53174__$1 = G__53179;
continue;
}
}
} else {
...
}),cljs.core.remove.call(null,(function (p1__53172_SHARP_){
return cljs.core.contains_QMARK_.call(null,disposed_ids,day8.re_frame.trace.graph.get_reaction.call(null,p1__53172_SHARP_));
...
return cljs.core.get_in.call(null,p1__53181_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.Keyword(null,"cached?","cached?",86081880)], null));
}),cljs.core.remove.call(null,(function (p1__53180_SHARP_){
return cljs.core.contains_QMARK_.call(null,disposed_ids,day8.re_frame.trace.graph.get_reaction.call(null,p1__53180_SHARP_));
}),day8.re_frame.trace.graph.select_type.call(null,type,traces)))));
});
...
return day8.re_frame.trace.graph.distinct_k.call(null,new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.remove.call(null,(function (p1__53183_SHARP_){
return (new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__53183_SHARP_) == null);
...
return cljs.core.contains_QMARK_.call(null,unmounted_components,day8.re_frame.trace.graph.get_reaction.call(null,p1__53182_SHARP_));
}),day8.re_frame.trace.graph.select_type.call(null,type,traces)))));
});
...
return (function (p__53185){
var map__53186 = p__53185;
var map__53186__$1 = ((((!((map__53186 == null)))?((((map__53186.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53186.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53186):map__53186);
var source = cljs.core.get.call(null,map__53186__$1,new cljs.core.Keyword(null,"source","source",-433931539));
var target = cljs.core.get.call(null,map__53186__$1,new cljs.core.Keyword(null,"target","target",253001721));
...
return cljs.core.get.call(null,missing_nodes,new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(p1__53184_SHARP_));
...
//# sourceMappingURL=graph.js.map?rel=1510609306385
