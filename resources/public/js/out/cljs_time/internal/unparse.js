...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__47852 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,((function (G__47852){
return (function (p1__47851_SHARP_){
return cljs.core.subs.call(null,p1__47851_SHARP_,(0),(3));
});})(G__47852))
,G__47852);
} else {
return G__47852;
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__47861){
var vec__47862 = p__47861;
var t = cljs.core.nth.call(null,vec__47862,(0),null);
var pattern = cljs.core.nth.call(null,vec__47862,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__47865 = pattern;
switch (G__47865) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47865)].join('')));
...
var G__47875 = key;
var G__47875__$1 = (((G__47875 instanceof cljs.core.Keyword))?G__47875.fqn:null);
switch (G__47875__$1) {
case "millis":
return ((function (G__47875,G__47875__$1){
return (function (p1__47867_SHARP_){
return p1__47867_SHARP_.getMilliseconds();
});
;})(G__47875,G__47875__$1))

break;
case "seconds":
return ((function (G__47875,G__47875__$1){
return (function (p1__47868_SHARP_){
return p1__47868_SHARP_.getSeconds();
});
;})(G__47875,G__47875__$1))
...
case "minutes":
return ((function (G__47875,G__47875__$1){
return (function (p1__47869_SHARP_){
return p1__47869_SHARP_.getMinutes();
});
;})(G__47875,G__47875__$1))
...
return p1__47870_SHARP_.getHours();
});
;})(G__47875,G__47875__$1))
...
return p1__47871_SHARP_.getHours();
});
;})(G__47875,G__47875__$1))
...
return p1__47872_SHARP_.getDate();
});
;})(G__47875,G__47875__$1))
...
return p1__47873_SHARP_.getMonth();
});
;})(G__47875,G__47875__$1))
...
return p1__47874_SHARP_.getYear();
});
;})(G__47875,G__47875__$1))

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47875__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__47877){
var vec__47878 = p__47877;
var seq__47879 = cljs.core.seq.call(null,vec__47878);
var first__47880 = cljs.core.first.call(null,seq__47879);
var seq__47879__$1 = cljs.core.next.call(null,seq__47879);
var key = first__47880;
var args = seq__47879__$1;
var G__47881 = key;
...
break;
case "ordinal-suffix":
var vec__47882 = syntax_list.call(null,(i - (1)));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47881__$1)].join('')));
...
var d = value;
var G__47889 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__47890 = G__47889;
var seq__47891 = cljs.core.seq.call(null,vec__47890);
var first__47892 = cljs.core.first.call(null,seq__47891);
var seq__47891__$1 = cljs.core.next.call(null,seq__47891);
var unparser = first__47892;
var more = seq__47891__$1;
var s = "";
var d__$1 = d;
var G__47889__$1 = G__47889;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__47893 = G__47889__$1;
var seq__47894 = cljs.core.seq.call(null,vec__47893);
var first__47895 = cljs.core.first.call(null,seq__47894);
var seq__47894__$1 = cljs.core.next.call(null,seq__47894);
var unparser__$1 = first__47895;
var more__$1 = seq__47894__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__47896 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__47896,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__47896,(1),null);
var G__47899 = d__$3;
var G__47900 = more__$1;
var G__47901 = s__$3;
d__$1 = G__47899;
G__47889__$1 = G__47900;
s__$1 = G__47901;
continue;
}
break;
...
//# sourceMappingURL=unparse.js.map?rel=1507056180462
