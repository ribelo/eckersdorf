...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__41726 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,((function (G__41726){
return (function (p1__41725_SHARP_){
return cljs.core.subs.call(null,p1__41725_SHARP_,(0),(3));
});})(G__41726))
,G__41726);
} else {
return G__41726;
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__41735){
var vec__41736 = p__41735;
var t = cljs.core.nth.call(null,vec__41736,(0),null);
var pattern = cljs.core.nth.call(null,vec__41736,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__41739 = pattern;
switch (G__41739) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41739)].join('')));
...
switch (G__41749__$1) {
case "millis":
return ((function (G__41749,G__41749__$1){
return (function (p1__41741_SHARP_){
return p1__41741_SHARP_.getMilliseconds();
});
;})(G__41749,G__41749__$1))

break;
case "seconds":
return ((function (G__41749,G__41749__$1){
return (function (p1__41742_SHARP_){
return p1__41742_SHARP_.getSeconds();
});
;})(G__41749,G__41749__$1))
...
return p1__41743_SHARP_.getMinutes();
});
;})(G__41749,G__41749__$1))
...
return p1__41744_SHARP_.getHours();
});
;})(G__41749,G__41749__$1))
...
return p1__41745_SHARP_.getHours();
});
;})(G__41749,G__41749__$1))
...
return p1__41746_SHARP_.getDate();
});
;})(G__41749,G__41749__$1))
...
return p1__41747_SHARP_.getMonth();
});
;})(G__41749,G__41749__$1))
...
case "year":
return ((function (G__41749,G__41749__$1){
return (function (p1__41748_SHARP_){
return p1__41748_SHARP_.getYear();
});
;})(G__41749,G__41749__$1))

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41749__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__41751){
var vec__41752 = p__41751;
var seq__41753 = cljs.core.seq.call(null,vec__41752);
var first__41754 = cljs.core.first.call(null,seq__41753);
var seq__41753__$1 = cljs.core.next.call(null,seq__41753);
var key = first__41754;
var args = seq__41753__$1;
var G__41755 = key;
...
break;
case "ordinal-suffix":
var vec__41756 = syntax_list.call(null,(i - (1)));
var k = cljs.core.nth.call(null,vec__41756,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41755__$1)].join('')));
...
var d = value;
var G__41763 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__41764 = G__41763;
...
var unparser = first__41766;
var more = seq__41765__$1;
var s = "";
var d__$1 = d;
var G__41763__$1 = G__41763;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__41767 = G__41763__$1;
...
var unparser__$1 = first__41769;
var more__$1 = seq__41768__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__41770 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__41770,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__41770,(1),null);
var G__41773 = d__$3;
var G__41774 = more__$1;
var G__41775 = s__$3;
d__$1 = G__41773;
G__41763__$1 = G__41774;
s__$1 = G__41775;
continue;
}
break;
...
//# sourceMappingURL=unparse.js.map?rel=1509397945264
