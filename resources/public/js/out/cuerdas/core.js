...
var len__31526__auto___38640 = arguments.length;
var i__31527__auto___38641 = (0);
while(true){
if((i__31527__auto___38641 < len__31526__auto___38640)){
args__31533__auto__.push((arguments[i__31527__auto___38641]));

var G__38642 = (i__31527__auto___38641 + (1));
i__31527__auto___38641 = G__38642;
continue;
} else {
}
break;
...
cuerdas.core.format.cljs$lang$applyTo = (function (seq38638){
var G__38639 = cljs.core.first.call(null,seq38638);
var seq38638__$1 = cljs.core.next.call(null,seq38638);
return cuerdas.core.format.cljs$core$IFn$_invoke$arity$variadic(G__38639,seq38638__$1);
});
...
var G__38652 = s;
var G__38652__$1 = (((G__38652 == null))?null:cljs.core.name.call(null,G__38652));
var G__38652__$2 = (((G__38652__$1 == null))?null:cuerdas.core.replace.call(null,G__38652__$1,re1,"-$1"));
var G__38652__$3 = (((G__38652__$2 == null))?null:cuerdas.core.split.call(null,G__38652__$2,re2));
if((G__38652__$3 == null)){
return null;
} else {
return cljs.core.seq.call(null,G__38652__$3);
}
});
...
cuerdas.core.stylize_join.cljs$core$IFn$_invoke$arity$4 = (function (p__38655,first_fn,rest_fn,join_with){
...
var fst = first__38658;
var rst = seq__38657__$1;
...
var remove_empty = (function (p1__38660_SHARP_){
return cljs.core.seq.call(null,cljs.core.remove.call(null,cuerdas.core.empty_QMARK_,p1__38660_SHARP_));
});
var G__38663 = cuerdas.core.stylize_split.call(null,s);
var G__38663__$1 = (((G__38663 == null))?null:remove_empty.call(null,G__38663));
if((G__38663__$1 == null)){
return null;
} else {
return cuerdas.core.stylize_join.call(null,G__38663__$1,first_fn,rest_fn,join_with);
}
});
...
var G__38665 = cuerdas.core.stylize_split.call(null,s);
if((G__38665 == null)){
return null;
} else {
return cuerdas.core.stylize_join.call(null,G__38665,cljs.core.identity,cuerdas.core.capital,"");
}
});
/**
 * Output will be either:
...
var G__38666 = cuerdas.core.stylize_split.call(null,s);
if((G__38666 == null)){
return null;
} else {
return cuerdas.core.stylize_join.call(null,G__38666,cuerdas.core.lower,"-");
}
});
...
var G__38667 = cuerdas.core.lower.call(null,s);
var G__38667__$1 = (((G__38667 == null))?null:clojure.string.escape.call(null,G__38667,cuerdas.core._PLUS_slug_tr_map_PLUS_));
var G__38667__$2 = (((G__38667__$1 == null))?null:cuerdas.core.replace.call(null,G__38667__$1,/[^\w\s]+/,""));
if((G__38667__$2 == null)){
return null;
} else {
return cuerdas.core.replace.call(null,G__38667__$2,/\s+/,"-");
}
});
/**
...
var G__38668 = cuerdas.core.lower.call(null,s);
var G__38668__$1 = (((G__38668 == null))?null:cuerdas.core.replace.call(null,G__38668,cuerdas.regexp.enhace.call(null,/[^\p{L}\p{N}]+/)," "));
if((G__38668__$1 == null)){
return null;
} else {
return cuerdas.core.replace.call(null,G__38668__$1,cuerdas.regexp.enhace.call(null,/[\p{Z}\s]+/),"-");
}
});
/**
...
return cljs.core.boolean$.call(null,cljs.core.some.call(null,(function (p1__38672_SHARP_){
return cljs.core._EQ_.call(null,p1__38672_SHARP_,s);
}),coll));
});
/**
...
var args__31533__auto__ = [];
var len__31526__auto___38684 = arguments.length;
var i__31527__auto___38685 = (0);
while(true){
if((i__31527__auto___38685 < len__31526__auto___38684)){
args__31533__auto__.push((arguments[i__31527__auto___38685]));

var G__38686 = (i__31527__auto___38685 + (1));
i__31527__auto___38685 = G__38686;
continue;
} else {
}
break;
...
cuerdas.core.pad.cljs$core$IFn$_invoke$arity$variadic = (function (s,p__38675){
var vec__38676 = p__38675;
var map__38679 = cljs.core.nth.call(null,vec__38676,(0),null);
...
var length = cljs.core.get.call(null,map__38679__$1,new cljs.core.Keyword(null,"length","length",588987862),(0));
var padding = cljs.core.get.call(null,map__38679__$1,new cljs.core.Keyword(null,"padding","padding",1660304693)," ");
var type = cljs.core.get.call(null,map__38679__$1,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"left","left",-399115937));
if(typeof s === 'string'){
var padding__$1 = cuerdas.core.slice.call(null,padding,(0),(1));
var padlen = (length - cljs.core.count.call(null,s));
var pred__38681 = cljs.core._EQ_;
var expr__38682 = type;
if(cljs.core.truth_(pred__38681.call(null,new cljs.core.Keyword(null,"right","right",-452581833),expr__38682))){
...
if(cljs.core.truth_(pred__38681.call(null,new cljs.core.Keyword(null,"both","both",-393648840),expr__38682))){
...
if(cljs.core.truth_(pred__38681.call(null,new cljs.core.Keyword(null,"left","left",-399115937),expr__38682))){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__38682)].join('')));
}
}
}
} else {
...
cuerdas.core.pad.cljs$lang$applyTo = (function (seq38673){
var G__38674 = cljs.core.first.call(null,seq38673);
var seq38673__$1 = cljs.core.next.call(null,seq38673);
return cuerdas.core.pad.cljs$core$IFn$_invoke$arity$variadic(G__38674,seq38673__$1);
});
...
var G__38687 = s;
var G__38687__$1 = (((G__38687 == null))?null:cuerdas.core.replace.call(null,G__38687,cuerdas.regexp.enhace.call(null,/[\p{Z}\s]+/)," "));
if((G__38687__$1 == null)){
return null;
} else {
return cuerdas.core.replace.call(null,G__38687__$1,/^\s+|\s+$/,"");
}
});
...
var match = cljs.core.nth.call(null,vec__38689,(0),null);
var tag = cljs.core.nth.call(null,vec__38689,(1),null);
var tag__$1 = kwdize.call(null,tag);
return cljs.core.get.call(null,mappings,tag__$1,"");
});})(kwdize,tags__$1,rx))
:((function (kwdize,tags__$1,rx){
return (function (p__38692){
var vec__38693 = p__38692;
var match = cljs.core.nth.call(null,vec__38693,(0),null);
var tag = cljs.core.nth.call(null,vec__38693,(1),null);
var tag__$1 = kwdize.call(null,tag);
...
var G__38699 = s;
var G__38699__$1 = (((G__38699 == null))?null:cuerdas.core.split.call(null,G__38699,prefix));
var G__38699__$2 = (((G__38699__$1 == null))?null:cljs.core.second.call(null,G__38699__$1));
var G__38699__$3 = (((G__38699__$2 == null))?null:cuerdas.core.split.call(null,G__38699__$2,suffix));
if((G__38699__$3 == null)){
return null;
} else {
return cljs.core.first.call(null,G__38699__$3);
}
...
var all_indents = cljs.core.map.call(null,(function (p1__38700_SHARP_){
return cljs.core.count.call(null,cljs.core.second.call(null,cljs.core.re_find.call(null,/^( +)/,p1__38700_SHARP_)));
...
return cuerdas.core.unlines.call(null,cljs.core.map.call(null,(function (p1__38701_SHARP_){
return cuerdas.core.replace.call(null,p1__38701_SHARP_,r,"");
...
//# sourceMappingURL=core.js.map?rel=1509397942907
