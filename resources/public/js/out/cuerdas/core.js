...
var len__31526__auto___38613 = arguments.length;
var i__31527__auto___38614 = (0);
while(true){
if((i__31527__auto___38614 < len__31526__auto___38613)){
args__31533__auto__.push((arguments[i__31527__auto___38614]));

var G__38615 = (i__31527__auto___38614 + (1));
i__31527__auto___38614 = G__38615;
continue;
} else {
}
break;
...
cuerdas.core.format.cljs$lang$applyTo = (function (seq38611){
var G__38612 = cljs.core.first.call(null,seq38611);
var seq38611__$1 = cljs.core.next.call(null,seq38611);
return cuerdas.core.format.cljs$core$IFn$_invoke$arity$variadic(G__38612,seq38611__$1);
});
...
var G__38625 = s;
var G__38625__$1 = (((G__38625 == null))?null:cljs.core.name.call(null,G__38625));
var G__38625__$2 = (((G__38625__$1 == null))?null:cuerdas.core.replace.call(null,G__38625__$1,re1,"-$1"));
var G__38625__$3 = (((G__38625__$2 == null))?null:cuerdas.core.split.call(null,G__38625__$2,re2));
if((G__38625__$3 == null)){
return null;
} else {
return cljs.core.seq.call(null,G__38625__$3);
}
});
...
cuerdas.core.stylize_join.cljs$core$IFn$_invoke$arity$4 = (function (p__38628,first_fn,rest_fn,join_with){
...
var fst = first__38631;
var rst = seq__38630__$1;
...
var remove_empty = (function (p1__38633_SHARP_){
return cljs.core.seq.call(null,cljs.core.remove.call(null,cuerdas.core.empty_QMARK_,p1__38633_SHARP_));
});
var G__38636 = cuerdas.core.stylize_split.call(null,s);
var G__38636__$1 = (((G__38636 == null))?null:remove_empty.call(null,G__38636));
if((G__38636__$1 == null)){
return null;
} else {
return cuerdas.core.stylize_join.call(null,G__38636__$1,first_fn,rest_fn,join_with);
}
});
...
var G__38638 = cuerdas.core.stylize_split.call(null,s);
if((G__38638 == null)){
return null;
} else {
return cuerdas.core.stylize_join.call(null,G__38638,cljs.core.identity,cuerdas.core.capital,"");
}
});
/**
 * Output will be either:
...
var G__38639 = cuerdas.core.stylize_split.call(null,s);
if((G__38639 == null)){
return null;
} else {
return cuerdas.core.stylize_join.call(null,G__38639,cuerdas.core.lower,"-");
}
});
...
var G__38640 = cuerdas.core.lower.call(null,s);
var G__38640__$1 = (((G__38640 == null))?null:clojure.string.escape.call(null,G__38640,cuerdas.core._PLUS_slug_tr_map_PLUS_));
var G__38640__$2 = (((G__38640__$1 == null))?null:cuerdas.core.replace.call(null,G__38640__$1,/[^\w\s]+/,""));
if((G__38640__$2 == null)){
return null;
} else {
return cuerdas.core.replace.call(null,G__38640__$2,/\s+/,"-");
}
});
/**
...
var G__38641 = cuerdas.core.lower.call(null,s);
var G__38641__$1 = (((G__38641 == null))?null:cuerdas.core.replace.call(null,G__38641,cuerdas.regexp.enhace.call(null,/[^\p{L}\p{N}]+/)," "));
if((G__38641__$1 == null)){
return null;
} else {
return cuerdas.core.replace.call(null,G__38641__$1,cuerdas.regexp.enhace.call(null,/[\p{Z}\s]+/),"-");
}
});
/**
...
return cljs.core.boolean$.call(null,cljs.core.some.call(null,(function (p1__38645_SHARP_){
return cljs.core._EQ_.call(null,p1__38645_SHARP_,s);
}),coll));
});
/**
...
var args__31533__auto__ = [];
var len__31526__auto___38657 = arguments.length;
var i__31527__auto___38658 = (0);
while(true){
if((i__31527__auto___38658 < len__31526__auto___38657)){
args__31533__auto__.push((arguments[i__31527__auto___38658]));

var G__38659 = (i__31527__auto___38658 + (1));
i__31527__auto___38658 = G__38659;
continue;
} else {
}
break;
...
cuerdas.core.pad.cljs$core$IFn$_invoke$arity$variadic = (function (s,p__38648){
var vec__38649 = p__38648;
var map__38652 = cljs.core.nth.call(null,vec__38649,(0),null);
...
var length = cljs.core.get.call(null,map__38652__$1,new cljs.core.Keyword(null,"length","length",588987862),(0));
var padding = cljs.core.get.call(null,map__38652__$1,new cljs.core.Keyword(null,"padding","padding",1660304693)," ");
var type = cljs.core.get.call(null,map__38652__$1,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"left","left",-399115937));
if(typeof s === 'string'){
var padding__$1 = cuerdas.core.slice.call(null,padding,(0),(1));
var padlen = (length - cljs.core.count.call(null,s));
var pred__38654 = cljs.core._EQ_;
var expr__38655 = type;
if(cljs.core.truth_(pred__38654.call(null,new cljs.core.Keyword(null,"right","right",-452581833),expr__38655))){
...
if(cljs.core.truth_(pred__38654.call(null,new cljs.core.Keyword(null,"both","both",-393648840),expr__38655))){
...
if(cljs.core.truth_(pred__38654.call(null,new cljs.core.Keyword(null,"left","left",-399115937),expr__38655))){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__38655)].join('')));
}
}
}
} else {
...
cuerdas.core.pad.cljs$lang$applyTo = (function (seq38646){
var G__38647 = cljs.core.first.call(null,seq38646);
var seq38646__$1 = cljs.core.next.call(null,seq38646);
return cuerdas.core.pad.cljs$core$IFn$_invoke$arity$variadic(G__38647,seq38646__$1);
});
...
var G__38660 = s;
var G__38660__$1 = (((G__38660 == null))?null:cuerdas.core.replace.call(null,G__38660,cuerdas.regexp.enhace.call(null,/[\p{Z}\s]+/)," "));
if((G__38660__$1 == null)){
return null;
} else {
return cuerdas.core.replace.call(null,G__38660__$1,/^\s+|\s+$/,"");
}
});
...
return (function (p__38661){
var vec__38662 = p__38661;
var match = cljs.core.nth.call(null,vec__38662,(0),null);
var tag = cljs.core.nth.call(null,vec__38662,(1),null);
var tag__$1 = kwdize.call(null,tag);
return cljs.core.get.call(null,mappings,tag__$1,"");
});})(kwdize,tags__$1,rx))
:((function (kwdize,tags__$1,rx){
return (function (p__38665){
var vec__38666 = p__38665;
var match = cljs.core.nth.call(null,vec__38666,(0),null);
var tag = cljs.core.nth.call(null,vec__38666,(1),null);
var tag__$1 = kwdize.call(null,tag);
...
var G__38672 = s;
var G__38672__$1 = (((G__38672 == null))?null:cuerdas.core.split.call(null,G__38672,prefix));
var G__38672__$2 = (((G__38672__$1 == null))?null:cljs.core.second.call(null,G__38672__$1));
var G__38672__$3 = (((G__38672__$2 == null))?null:cuerdas.core.split.call(null,G__38672__$2,suffix));
if((G__38672__$3 == null)){
return null;
} else {
return cljs.core.first.call(null,G__38672__$3);
}
...
var all_indents = cljs.core.map.call(null,(function (p1__38673_SHARP_){
return cljs.core.count.call(null,cljs.core.second.call(null,cljs.core.re_find.call(null,/^( +)/,p1__38673_SHARP_)));
...
return cuerdas.core.unlines.call(null,cljs.core.map.call(null,(function (p1__38674_SHARP_){
return cuerdas.core.replace.call(null,p1__38674_SHARP_,r,"");
...
//# sourceMappingURL=core.js.map?rel=1507056173383
