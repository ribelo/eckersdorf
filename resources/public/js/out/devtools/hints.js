...
var file = cljs.core.get.call(null,map__53335__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__53335__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__53335__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e53334){var _e = e53334;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5288__auto___53337 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5288__auto___53337)){
var seen_errors_53338 = temp__5288__auto___53337;
if(cljs.core.truth_(seen_errors_53338.has(self))){
} else {
seen_errors_53338.add(self);

var temp__5290__auto___53339 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5290__auto___53339)){
var sense_53340 = temp__5290__auto___53339;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_53340)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1509094257352
