...
var line = cljs.core.get.call(null,map__53089__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__53089__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e53088){var _e = e53088;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5288__auto___53091 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5288__auto___53091)){
var seen_errors_53092 = temp__5288__auto___53091;
if(cljs.core.truth_(seen_errors_53092.has(self))){
} else {
seen_errors_53092.add(self);

var temp__5290__auto___53093 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5290__auto___53093)){
var sense_53094 = temp__5290__auto___53093;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_53094)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1508862166152
