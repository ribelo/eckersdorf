...
var map__57059 = top_item;
var map__57059__$1 = ((((!((map__57059 == null)))?((((map__57059.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57059.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__57059):map__57059);
var file = cljs.core.get.call(null,map__57059__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__57059__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__57059__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e57058){var _e = e57058;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5288__auto___57061 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5288__auto___57061)){
var seen_errors_57062 = temp__5288__auto___57061;
if(cljs.core.truth_(seen_errors_57062.has(self))){
} else {
seen_errors_57062.add(self);

var temp__5290__auto___57063 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5290__auto___57063)){
var sense_57064 = temp__5290__auto___57063;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_57064)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1507056186206
