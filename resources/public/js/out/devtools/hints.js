...
var temp__5288__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
if(cljs.core.truth_(temp__5288__auto__)){
var val = temp__5288__auto__;
return val;
} else {
...
var reader = (function (){var or__30249__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__30249__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__30249__auto__)){
return or__30249__auto__;
} else {
return (128);
...
var map__52872 = top_item;
var map__52872__$1 = ((((!((map__52872 == null)))?((((map__52872.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52872.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52872):map__52872);
var file = cljs.core.get.call(null,map__52872__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__52872__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__52872__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e52871){var _e = e52871;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5288__auto___52874 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5288__auto___52874)){
var seen_errors_52875 = temp__5288__auto___52874;
if(cljs.core.truth_(seen_errors_52875.has(self))){
} else {
seen_errors_52875.add(self);

var temp__5290__auto___52876 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5290__auto___52876)){
var sense_52877 = temp__5290__auto___52876;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_52877)].join('');
} else {
}
}
} else {
...
var temp__5290__auto__ = devtools.hints.error_object_sense.call(null,error);
if(cljs.core.truth_(temp__5290__auto__)){
var sense = temp__5290__auto__;
...
//# sourceMappingURL=hints.js.map?rel=1506985658654
