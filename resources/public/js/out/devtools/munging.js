...
var o50707 = temp__5455__auto__;
var temp__5455__auto____$1 = (o50707["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o50708 = temp__5455__auto____$1;
return (o50708["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__35424__auto__ = f;
return (o__35424__auto__["toString"]).call(o__35424__auto__);
} else {
return "";
}
}catch (e50709){var _ = e50709;
return "";
}});
...
try{var o__35424__auto___50711 = t;
(o__35424__auto___50711["cljs$lang$ctorPrWriter"]).call(o__35424__auto___50711,t,writer);
}catch (e50710){var __50712 = e50710;
}
...
var char_code = (function (){var o__35424__auto__ = (new String(char$));
return (o__35424__auto__["charCodeAt"]).call(o__35424__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__35424__auto__ = String;
return (o__35424__auto__["fromCharCode"]).call(o__35424__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__50713 = num_code;
switch (G__50713) {
case (1):
return (185);
...
var o__35424__auto__ = String;
return (o__35424__auto__["fromCharCode"]).call(o__35424__auto__,superscript_code);
});
/**
...
}catch (e50715){var _e__35431__auto__ = e50715;
return false;
}})())){
...
var vec__50716 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__50716,(0),null);
...
var or__30523__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o50719 = temp__5455__auto__;
var temp__5455__auto____$1 = (o50719["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o50720 = temp__5455__auto____$1;
return (o50720["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31802__auto___50727 = arguments.length;
var i__31803__auto___50728 = (0);
while(true){
if((i__31803__auto___50728 < len__31802__auto___50727)){
args__31809__auto__.push((arguments[i__31803__auto___50728]));

var G__50729 = (i__31803__auto___50728 + (1));
i__31803__auto___50728 = G__50729;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31810__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__50723){
var vec__50724 = p__50723;
var ns_detector = cljs.core.nth.call(null,vec__50724,(0),null);
var effective_detector = (function (){var or__30523__auto__ = ns_detector;
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
...
var G__50730 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__50731 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__50730;
remaining_tokens = G__50731;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq50721){
var G__50722 = cljs.core.first.call(null,seq50721);
var seq50721__$1 = cljs.core.next.call(null,seq50721);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__50722,seq50721__$1);
});
...
var vec__50735 = cljs.core.split_with.call(null,(function (p1__50734_SHARP_){
return cljs.core.not_EQ_.call(null,p1__50734_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__50735,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__50735,(1),null);
...
var vec__50738 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__50738,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__50738,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__50741 = cljs.core.rest.call(null,remaining_tokens);
var G__50742 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__50741;
name_tokens = G__50742;
continue;
} else {
...
var vec__50745 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__50745,(0),null);
var arity = cljs.core.nth.call(null,vec__50745,(1),null);
var vec__50748 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__50748,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__50748,(1),null);
var vec__50751 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__50751,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__50751,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__50751,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__50751,(3),null);
...
var vec__50757 = result;
var munged_ns = cljs.core.nth.call(null,vec__50757,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__50757,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__50757,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__50757,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__50757,(4),null);
var arity = cljs.core.nth.call(null,vec__50757,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__50761 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__50761,(0),null);
var args = cljs.core.nth.call(null,vec__50761,(1),null);
var vec__50764 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__50764,(0),null);
var name = cljs.core.nth.call(null,vec__50764,(1),null);
...
var G__50767 = (arity + (1));
var G__50768 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__50769){
var vec__50770 = p__50769;
var arity = cljs.core.nth.call(null,vec__50770,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__50770,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30523__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__50773_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__50774_SHARP_);
...
var args__31809__auto__ = [];
var len__31802__auto___50781 = arguments.length;
var i__31803__auto___50782 = (0);
while(true){
if((i__31803__auto___50782 < len__31802__auto___50781)){
args__31809__auto__.push((arguments[i__31803__auto___50782]));

var G__50783 = (i__31803__auto___50782 + (1));
i__31803__auto___50782 = G__50783;
continue;
} else {
}
break;
...
var argseq__31810__auto__ = ((((1) < args__31809__auto__.length))?(new cljs.core.IndexedSeq(args__31809__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31810__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__50777){
var vec__50778 = p__50777;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__50778,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq50775){
var G__50776 = cljs.core.first.call(null,seq50775);
var seq50775__$1 = cljs.core.next.call(null,seq50775);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__50776,seq50775__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30523__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30511__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30523__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
...
var map__50786 = options;
var map__50786__$1 = ((((!((map__50786 == null)))?((((map__50786.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50786.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50786):map__50786);
var include_ns_QMARK_ = cljs.core.get.call(null,map__50786__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__50786__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__50786__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__50786__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__50787 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__50787,(0),null);
var fn_name = cljs.core.nth.call(null,vec__50787,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__50787,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__50787,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__50787,(4),null);
var arity = cljs.core.nth.call(null,vec__50787,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30511__auto__ = protocol_ns;
if(cljs.core.truth_(and__30511__auto__)){
return cljs.core.not.call(null,(function (){var and__30511__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30523__auto__ = protocol_part;
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
return fn_part;
...
var o__35424__auto__ = f;
return (o__35424__auto__["getBasis"]).call(o__35424__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30511__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30511__auto__)){
...
}catch (e50791){var _e__35431__auto__ = e50791;
...
var G__50792 = (obj[cljs.core.first.call(null,path)]);
var G__50793 = cljs.core.rest.call(null,path);
obj = G__50792;
path = G__50793;
continue;
} else {
...
var partition_bits = (function (){var or__30523__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
return (0);
...
return (function (accum,p__50794){
var vec__50795 = p__50794;
var bit = cljs.core.nth.call(null,vec__50795,(0),null);
var protocol = cljs.core.nth.call(null,vec__50795,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__50798){
var vec__50799 = p__50798;
var ns = cljs.core.nth.call(null,vec__50799,(0),null);
var name = cljs.core.nth.call(null,vec__50799,(1),null);
var selector = cljs.core.nth.call(null,vec__50799,(2),null);
...
return (function (p__50803){
var vec__50804 = p__50803;
var munged_name = cljs.core.nth.call(null,vec__50804,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__50804,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__50804,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__50802_SHARP_){
return (obj[cljs.core.first.call(null,p1__50802_SHARP_)]);
});})(name,sorted_matches,vec__50804,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1510609303181
