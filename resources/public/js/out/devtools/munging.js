...
var o51036 = temp__5288__auto__;
var temp__5288__auto____$1 = (o51036["core"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o51037 = temp__5288__auto____$1;
return (o51037["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39531__auto__ = f;
return (o__39531__auto__["toString"]).call(o__39531__auto__);
} else {
return "";
}
}catch (e51038){var _ = e51038;
return "";
}});
...
try{var o__39531__auto___51040 = t;
(o__39531__auto___51040["cljs$lang$ctorPrWriter"]).call(o__39531__auto___51040,t,writer);
}catch (e51039){var __51041 = e51039;
}
...
var char_code = (function (){var o__39531__auto__ = (new String(char$));
return (o__39531__auto__["charCodeAt"]).call(o__39531__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39531__auto__ = String;
return (o__39531__auto__["fromCharCode"]).call(o__39531__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__51042 = num_code;
switch (G__51042) {
case (1):
return (185);
...
var o__39531__auto__ = String;
return (o__39531__auto__["fromCharCode"]).call(o__39531__auto__,superscript_code);
});
/**
...
}catch (e51044){var _e__39538__auto__ = e51044;
return false;
}})())){
...
var vec__51045 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__51045,(0),null);
...
if(cljs.core.truth_(temp__5288__auto__)){
var o51048 = temp__5288__auto__;
var temp__5288__auto____$1 = (o51048["dependencies_"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o51049 = temp__5288__auto____$1;
return (o51049["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31526__auto___51056 = arguments.length;
var i__31527__auto___51057 = (0);
while(true){
if((i__31527__auto___51057 < len__31526__auto___51056)){
args__31533__auto__.push((arguments[i__31527__auto___51057]));

var G__51058 = (i__31527__auto___51057 + (1));
i__31527__auto___51057 = G__51058;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__51052){
var vec__51053 = p__51052;
var ns_detector = cljs.core.nth.call(null,vec__51053,(0),null);
...
var G__51059 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__51060 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__51059;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq51050){
var G__51051 = cljs.core.first.call(null,seq51050);
var seq51050__$1 = cljs.core.next.call(null,seq51050);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__51051,seq51050__$1);
});
...
var vec__51064 = cljs.core.split_with.call(null,(function (p1__51063_SHARP_){
return cljs.core.not_EQ_.call(null,p1__51063_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__51064,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__51064,(1),null);
...
var vec__51067 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__51067,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__51067,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__51070 = cljs.core.rest.call(null,remaining_tokens);
var G__51071 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__51070;
name_tokens = G__51071;
continue;
} else {
...
var vec__51074 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__51074,(0),null);
var arity = cljs.core.nth.call(null,vec__51074,(1),null);
var vec__51077 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__51077,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__51077,(1),null);
var vec__51080 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__51080,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__51080,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__51080,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__51080,(3),null);
...
var vec__51086 = result;
var munged_ns = cljs.core.nth.call(null,vec__51086,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__51086,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__51086,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__51086,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__51086,(4),null);
var arity = cljs.core.nth.call(null,vec__51086,(5),null);
...
if(cljs.core.truth_(temp__5288__auto__)){
var vec__51090 = temp__5288__auto__;
var munged_name = cljs.core.nth.call(null,vec__51090,(0),null);
var args = cljs.core.nth.call(null,vec__51090,(1),null);
var vec__51093 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__51093,(0),null);
var name = cljs.core.nth.call(null,vec__51093,(1),null);
...
var G__51096 = (arity + (1));
var G__51097 = (function (){var temp__5288__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5288__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__51098){
var vec__51099 = p__51098;
var arity = cljs.core.nth.call(null,vec__51099,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__51099,(1),null);
...
return cljs.core.get.call(null,arities,p1__51102_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__51103_SHARP_){
return cljs.core.drop.call(null,(2),p1__51103_SHARP_);
...
var args__31533__auto__ = [];
var len__31526__auto___51110 = arguments.length;
var i__31527__auto___51111 = (0);
while(true){
if((i__31527__auto___51111 < len__31526__auto___51110)){
args__31533__auto__.push((arguments[i__31527__auto___51111]));

var G__51112 = (i__31527__auto___51111 + (1));
i__31527__auto___51111 = G__51112;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__51106){
var vec__51107 = p__51106;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__51107,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq51104){
var G__51105 = cljs.core.first.call(null,seq51104);
var seq51104__$1 = cljs.core.next.call(null,seq51104);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__51105,seq51104__$1);
});
...
var G__51113 = arg;
var G__51113__$1 = (((G__51113 instanceof cljs.core.Keyword))?G__51113.fqn:null);
switch (G__51113__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__51115__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__51115__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__51115__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__51115__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__51116 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__51116,(0),null);
var fn_name = cljs.core.nth.call(null,vec__51116,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__51116,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__51116,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__51116,(4),null);
var arity = cljs.core.nth.call(null,vec__51116,(5),null);
...
var o__39531__auto__ = f;
return (o__39531__auto__["getBasis"]).call(o__39531__auto__);
});
/**
...
}catch (e51120){var _e__39538__auto__ = e51120;
...
var G__51121 = (obj[cljs.core.first.call(null,path)]);
var G__51122 = cljs.core.rest.call(null,path);
obj = G__51121;
path = G__51122;
continue;
} else {
...
return (function (accum,p__51123){
var vec__51124 = p__51123;
var bit = cljs.core.nth.call(null,vec__51124,(0),null);
var protocol = cljs.core.nth.call(null,vec__51124,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__51127){
var vec__51128 = p__51127;
var ns = cljs.core.nth.call(null,vec__51128,(0),null);
var name = cljs.core.nth.call(null,vec__51128,(1),null);
var selector = cljs.core.nth.call(null,vec__51128,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__51133,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__51133,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__51133,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__51131_SHARP_){
return (obj[cljs.core.first.call(null,p1__51131_SHARP_)]);
});})(name,sorted_matches,vec__51133,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506985656599
