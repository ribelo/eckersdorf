...
var o35098 = temp__5288__auto__;
var temp__5288__auto____$1 = (o35098["core"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o35099 = temp__5288__auto____$1;
return (o35099["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__34208__auto__ = f;
return (o__34208__auto__["toString"]).call(o__34208__auto__);
} else {
return "";
}
}catch (e35100){var _ = e35100;
return "";
}});
...
try{var o__34208__auto___35102 = t;
(o__34208__auto___35102["cljs$lang$ctorPrWriter"]).call(o__34208__auto___35102,t,writer);
}catch (e35101){var __35103 = e35101;
}
...
var char_code = (function (){var o__34208__auto__ = (new String(char$));
return (o__34208__auto__["charCodeAt"]).call(o__34208__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34208__auto__ = String;
return (o__34208__auto__["fromCharCode"]).call(o__34208__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__35104 = num_code;
switch (G__35104) {
case (1):
return (185);
...
var o__34208__auto__ = String;
return (o__34208__auto__["fromCharCode"]).call(o__34208__auto__,superscript_code);
});
/**
...
}catch (e35106){var _e__34215__auto__ = e35106;
return false;
}})())){
...
var vec__35107 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__35107,(0),null);
...
if(cljs.core.truth_(temp__5288__auto__)){
var o35110 = temp__5288__auto__;
var temp__5288__auto____$1 = (o35110["dependencies_"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o35111 = temp__5288__auto____$1;
return (o35111["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31526__auto___35118 = arguments.length;
var i__31527__auto___35119 = (0);
while(true){
if((i__31527__auto___35119 < len__31526__auto___35118)){
args__31533__auto__.push((arguments[i__31527__auto___35119]));

var G__35120 = (i__31527__auto___35119 + (1));
i__31527__auto___35119 = G__35120;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__35114){
var vec__35115 = p__35114;
var ns_detector = cljs.core.nth.call(null,vec__35115,(0),null);
...
var G__35121 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__35122 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__35121;
remaining_tokens = G__35122;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq35112){
var G__35113 = cljs.core.first.call(null,seq35112);
var seq35112__$1 = cljs.core.next.call(null,seq35112);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__35113,seq35112__$1);
});
...
var vec__35126 = cljs.core.split_with.call(null,(function (p1__35125_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35125_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__35126,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__35126,(1),null);
...
var vec__35129 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__35129,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__35129,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__35132 = cljs.core.rest.call(null,remaining_tokens);
var G__35133 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__35132;
name_tokens = G__35133;
continue;
} else {
...
var vec__35136 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__35136,(0),null);
var arity = cljs.core.nth.call(null,vec__35136,(1),null);
var vec__35139 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__35139,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__35139,(1),null);
var vec__35142 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__35142,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__35142,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__35142,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__35142,(3),null);
...
var vec__35148 = result;
var munged_ns = cljs.core.nth.call(null,vec__35148,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__35148,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__35148,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__35148,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__35148,(4),null);
var arity = cljs.core.nth.call(null,vec__35148,(5),null);
...
if(cljs.core.truth_(temp__5288__auto__)){
var vec__35152 = temp__5288__auto__;
var munged_name = cljs.core.nth.call(null,vec__35152,(0),null);
var args = cljs.core.nth.call(null,vec__35152,(1),null);
var vec__35155 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__35155,(0),null);
var name = cljs.core.nth.call(null,vec__35155,(1),null);
...
var G__35158 = (arity + (1));
var G__35159 = (function (){var temp__5288__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5288__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__35160){
var vec__35161 = p__35160;
var arity = cljs.core.nth.call(null,vec__35161,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__35161,(1),null);
...
return cljs.core.get.call(null,arities,p1__35164_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__35165_SHARP_);
...
var args__31533__auto__ = [];
var len__31526__auto___35172 = arguments.length;
var i__31527__auto___35173 = (0);
while(true){
if((i__31527__auto___35173 < len__31526__auto___35172)){
args__31533__auto__.push((arguments[i__31527__auto___35173]));

var G__35174 = (i__31527__auto___35173 + (1));
i__31527__auto___35173 = G__35174;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__35168){
var vec__35169 = p__35168;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__35169,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq35166){
var G__35167 = cljs.core.first.call(null,seq35166);
var seq35166__$1 = cljs.core.next.call(null,seq35166);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__35167,seq35166__$1);
});
...
var G__35175 = arg;
var G__35175__$1 = (((G__35175 instanceof cljs.core.Keyword))?G__35175.fqn:null);
switch (G__35175__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__35177__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__35177__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__35177__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__35177__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__35178 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__35178,(0),null);
var fn_name = cljs.core.nth.call(null,vec__35178,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__35178,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__35178,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__35178,(4),null);
var arity = cljs.core.nth.call(null,vec__35178,(5),null);
...
var o__34208__auto__ = f;
return (o__34208__auto__["getBasis"]).call(o__34208__auto__);
});
/**
...
}catch (e35182){var _e__34215__auto__ = e35182;
...
var G__35183 = (obj[cljs.core.first.call(null,path)]);
var G__35184 = cljs.core.rest.call(null,path);
obj = G__35183;
path = G__35184;
continue;
} else {
...
return (function (accum,p__35185){
var vec__35186 = p__35185;
var bit = cljs.core.nth.call(null,vec__35186,(0),null);
var protocol = cljs.core.nth.call(null,vec__35186,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__35189){
var vec__35190 = p__35189;
var ns = cljs.core.nth.call(null,vec__35190,(0),null);
var name = cljs.core.nth.call(null,vec__35190,(1),null);
var selector = cljs.core.nth.call(null,vec__35190,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__35195,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__35195,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__35195,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__35193_SHARP_){
return (obj[cljs.core.first.call(null,p1__35193_SHARP_)]);
});})(name,sorted_matches,vec__35195,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506023157654
