...
var o51253 = temp__5288__auto__;
var temp__5288__auto____$1 = (o51253["core"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o51254 = temp__5288__auto____$1;
return (o51254["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__39532__auto___51257 = t;
(o__39532__auto___51257["cljs$lang$ctorPrWriter"]).call(o__39532__auto___51257,t,writer);
}catch (e51256){var __51258 = e51256;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__51259 = num_code;
switch (G__51259) {
case (1):
return (185);
...
}catch (e51261){var _e__39539__auto__ = e51261;
return false;
}})())){
...
var vec__51262 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__51262,(0),null);
...
if(cljs.core.truth_(temp__5288__auto__)){
var o51265 = temp__5288__auto__;
var temp__5288__auto____$1 = (o51265["dependencies_"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o51266 = temp__5288__auto____$1;
return (o51266["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31526__auto___51273 = arguments.length;
var i__31527__auto___51274 = (0);
while(true){
if((i__31527__auto___51274 < len__31526__auto___51273)){
args__31533__auto__.push((arguments[i__31527__auto___51274]));

var G__51275 = (i__31527__auto___51274 + (1));
i__31527__auto___51274 = G__51275;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__51269){
var vec__51270 = p__51269;
var ns_detector = cljs.core.nth.call(null,vec__51270,(0),null);
...
var G__51276 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__51277 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__51276;
remaining_tokens = G__51277;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq51267){
var G__51268 = cljs.core.first.call(null,seq51267);
var seq51267__$1 = cljs.core.next.call(null,seq51267);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__51268,seq51267__$1);
});
...
var vec__51281 = cljs.core.split_with.call(null,(function (p1__51280_SHARP_){
return cljs.core.not_EQ_.call(null,p1__51280_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__51281,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__51281,(1),null);
...
var vec__51284 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__51284,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__51284,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__51287 = cljs.core.rest.call(null,remaining_tokens);
var G__51288 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__51287;
name_tokens = G__51288;
continue;
} else {
...
var vec__51291 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__51291,(0),null);
var arity = cljs.core.nth.call(null,vec__51291,(1),null);
var vec__51294 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__51294,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__51294,(1),null);
var vec__51297 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__51297,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__51297,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__51297,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__51297,(3),null);
...
var vec__51303 = result;
var munged_ns = cljs.core.nth.call(null,vec__51303,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__51303,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__51303,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__51303,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__51303,(4),null);
var arity = cljs.core.nth.call(null,vec__51303,(5),null);
...
if(cljs.core.truth_(temp__5288__auto__)){
var vec__51307 = temp__5288__auto__;
var munged_name = cljs.core.nth.call(null,vec__51307,(0),null);
var args = cljs.core.nth.call(null,vec__51307,(1),null);
var vec__51310 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__51310,(0),null);
var name = cljs.core.nth.call(null,vec__51310,(1),null);
...
var G__51313 = (arity + (1));
var G__51314 = (function (){var temp__5288__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5288__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__51315){
var vec__51316 = p__51315;
var arity = cljs.core.nth.call(null,vec__51316,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__51316,(1),null);
...
return (function (p1__51319_SHARP_){
return cljs.core.get.call(null,arities,p1__51319_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__51320_SHARP_);
...
var args__31533__auto__ = [];
var len__31526__auto___51327 = arguments.length;
var i__31527__auto___51328 = (0);
while(true){
if((i__31527__auto___51328 < len__31526__auto___51327)){
args__31533__auto__.push((arguments[i__31527__auto___51328]));

var G__51329 = (i__31527__auto___51328 + (1));
i__31527__auto___51328 = G__51329;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__51323){
var vec__51324 = p__51323;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__51324,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq51321){
var G__51322 = cljs.core.first.call(null,seq51321);
var seq51321__$1 = cljs.core.next.call(null,seq51321);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__51322,seq51321__$1);
});
...
var map__51332 = options;
var map__51332__$1 = ((((!((map__51332 == null)))?((((map__51332.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51332.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51332):map__51332);
var include_ns_QMARK_ = cljs.core.get.call(null,map__51332__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__51332__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__51332__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__51332__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__51333 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__51333,(0),null);
var fn_name = cljs.core.nth.call(null,vec__51333,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__51333,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__51333,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__51333,(4),null);
var arity = cljs.core.nth.call(null,vec__51333,(5),null);
...
}catch (e51337){var _e__39539__auto__ = e51337;
...
var G__51338 = (obj[cljs.core.first.call(null,path)]);
var G__51339 = cljs.core.rest.call(null,path);
obj = G__51338;
path = G__51339;
continue;
} else {
...
return (function (accum,p__51340){
var vec__51341 = p__51340;
var bit = cljs.core.nth.call(null,vec__51341,(0),null);
var protocol = cljs.core.nth.call(null,vec__51341,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__51344){
var vec__51345 = p__51344;
var ns = cljs.core.nth.call(null,vec__51345,(0),null);
var name = cljs.core.nth.call(null,vec__51345,(1),null);
var selector = cljs.core.nth.call(null,vec__51345,(2),null);
...
return (function (p__51349){
var vec__51350 = p__51349;
var munged_name = cljs.core.nth.call(null,vec__51350,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__51350,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__51350,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__51348_SHARP_){
return (obj[cljs.core.first.call(null,p1__51348_SHARP_)]);
});})(name,sorted_matches,vec__51350,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1508862164277
