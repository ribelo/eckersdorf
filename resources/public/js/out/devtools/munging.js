...
var o50706 = temp__5455__auto__;
var temp__5455__auto____$1 = (o50706["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o50707 = temp__5455__auto____$1;
return (o50707["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__35423__auto__ = f;
return (o__35423__auto__["toString"]).call(o__35423__auto__);
} else {
return "";
}
}catch (e50708){var _ = e50708;
return "";
}});
...
try{var o__35423__auto___50710 = t;
(o__35423__auto___50710["cljs$lang$ctorPrWriter"]).call(o__35423__auto___50710,t,writer);
}catch (e50709){var __50711 = e50709;
}
...
var char_code = (function (){var o__35423__auto__ = (new String(char$));
return (o__35423__auto__["charCodeAt"]).call(o__35423__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__35423__auto__ = String;
return (o__35423__auto__["fromCharCode"]).call(o__35423__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__50712 = num_code;
switch (G__50712) {
case (1):
return (185);
...
var o__35423__auto__ = String;
return (o__35423__auto__["fromCharCode"]).call(o__35423__auto__,superscript_code);
});
/**
...
}catch (e50714){var _e__35430__auto__ = e50714;
return false;
}})())){
...
var vec__50715 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__50715,(0),null);
...
var or__30522__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o50718 = temp__5455__auto__;
var temp__5455__auto____$1 = (o50718["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o50719 = temp__5455__auto____$1;
return (o50719["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31801__auto___50726 = arguments.length;
var i__31802__auto___50727 = (0);
while(true){
if((i__31802__auto___50727 < len__31801__auto___50726)){
args__31808__auto__.push((arguments[i__31802__auto___50727]));

var G__50728 = (i__31802__auto___50727 + (1));
i__31802__auto___50727 = G__50728;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31809__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__50722){
var vec__50723 = p__50722;
var ns_detector = cljs.core.nth.call(null,vec__50723,(0),null);
var effective_detector = (function (){var or__30522__auto__ = ns_detector;
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
} else {
...
var G__50729 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__50730 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__50729;
remaining_tokens = G__50730;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq50720){
var G__50721 = cljs.core.first.call(null,seq50720);
var seq50720__$1 = cljs.core.next.call(null,seq50720);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__50721,seq50720__$1);
});
...
var vec__50734 = cljs.core.split_with.call(null,(function (p1__50733_SHARP_){
return cljs.core.not_EQ_.call(null,p1__50733_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__50734,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__50734,(1),null);
...
var vec__50737 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__50737,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__50737,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__50740 = cljs.core.rest.call(null,remaining_tokens);
var G__50741 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__50740;
name_tokens = G__50741;
continue;
} else {
...
var vec__50744 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__50744,(0),null);
var arity = cljs.core.nth.call(null,vec__50744,(1),null);
var vec__50747 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__50747,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__50747,(1),null);
var vec__50750 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__50750,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__50750,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__50750,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__50750,(3),null);
...
var vec__50756 = result;
var munged_ns = cljs.core.nth.call(null,vec__50756,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__50756,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__50756,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__50756,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__50756,(4),null);
var arity = cljs.core.nth.call(null,vec__50756,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__50760 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__50760,(0),null);
var args = cljs.core.nth.call(null,vec__50760,(1),null);
var vec__50763 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__50763,(0),null);
var name = cljs.core.nth.call(null,vec__50763,(1),null);
...
var G__50766 = (arity + (1));
var G__50767 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__50768){
var vec__50769 = p__50768;
var arity = cljs.core.nth.call(null,vec__50769,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__50769,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30522__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__50772_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__50773_SHARP_);
...
var args__31808__auto__ = [];
var len__31801__auto___50780 = arguments.length;
var i__31802__auto___50781 = (0);
while(true){
if((i__31802__auto___50781 < len__31801__auto___50780)){
args__31808__auto__.push((arguments[i__31802__auto___50781]));

var G__50782 = (i__31802__auto___50781 + (1));
i__31802__auto___50781 = G__50782;
continue;
} else {
}
break;
...
var argseq__31809__auto__ = ((((1) < args__31808__auto__.length))?(new cljs.core.IndexedSeq(args__31808__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31809__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__50776){
var vec__50777 = p__50776;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__50777,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq50774){
var G__50775 = cljs.core.first.call(null,seq50774);
var seq50774__$1 = cljs.core.next.call(null,seq50774);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__50775,seq50774__$1);
});
...
var G__50783 = arg;
var G__50783__$1 = (((G__50783 instanceof cljs.core.Keyword))?G__50783.fqn:null);
switch (G__50783__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30522__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30510__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30522__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
} else {
...
var map__50785 = options;
var map__50785__$1 = ((((!((map__50785 == null)))?((((map__50785.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50785.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50785):map__50785);
var include_ns_QMARK_ = cljs.core.get.call(null,map__50785__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__50785__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__50785__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__50785__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__50786 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__50786,(0),null);
var fn_name = cljs.core.nth.call(null,vec__50786,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__50786,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__50786,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__50786,(4),null);
var arity = cljs.core.nth.call(null,vec__50786,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30510__auto__ = protocol_ns;
if(cljs.core.truth_(and__30510__auto__)){
return cljs.core.not.call(null,(function (){var and__30510__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30522__auto__ = protocol_part;
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
} else {
return fn_part;
...
var o__35423__auto__ = f;
return (o__35423__auto__["getBasis"]).call(o__35423__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30510__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30510__auto__)){
...
}catch (e50790){var _e__35430__auto__ = e50790;
...
var G__50791 = (obj[cljs.core.first.call(null,path)]);
var G__50792 = cljs.core.rest.call(null,path);
obj = G__50791;
path = G__50792;
continue;
} else {
...
var partition_bits = (function (){var or__30522__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
} else {
return (0);
...
return (function (accum,p__50793){
var vec__50794 = p__50793;
var bit = cljs.core.nth.call(null,vec__50794,(0),null);
var protocol = cljs.core.nth.call(null,vec__50794,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__50797){
var vec__50798 = p__50797;
var ns = cljs.core.nth.call(null,vec__50798,(0),null);
var name = cljs.core.nth.call(null,vec__50798,(1),null);
var selector = cljs.core.nth.call(null,vec__50798,(2),null);
...
return (function (p__50802){
var vec__50803 = p__50802;
var munged_name = cljs.core.nth.call(null,vec__50803,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__50803,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__50803,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__50801_SHARP_){
return (obj[cljs.core.first.call(null,p1__50801_SHARP_)]);
});})(name,sorted_matches,vec__50803,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1510602158518
