...
var o50709 = temp__5455__auto__;
var temp__5455__auto____$1 = (o50709["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o50710 = temp__5455__auto____$1;
return (o50710["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__35424__auto___50713 = t;
(o__35424__auto___50713["cljs$lang$ctorPrWriter"]).call(o__35424__auto___50713,t,writer);
}catch (e50712){var __50714 = e50712;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__50715 = num_code;
switch (G__50715) {
case (1):
return (185);
...
}catch (e50717){var _e__35431__auto__ = e50717;
return false;
}})())){
...
var vec__50718 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__50718,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o50721 = temp__5455__auto__;
var temp__5455__auto____$1 = (o50721["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o50722 = temp__5455__auto____$1;
return (o50722["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31802__auto___50729 = arguments.length;
var i__31803__auto___50730 = (0);
while(true){
if((i__31803__auto___50730 < len__31802__auto___50729)){
args__31809__auto__.push((arguments[i__31803__auto___50730]));

var G__50731 = (i__31803__auto___50730 + (1));
i__31803__auto___50730 = G__50731;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__50725){
var vec__50726 = p__50725;
var ns_detector = cljs.core.nth.call(null,vec__50726,(0),null);
...
var G__50732 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__50733 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__50732;
remaining_tokens = G__50733;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq50723){
var G__50724 = cljs.core.first.call(null,seq50723);
var seq50723__$1 = cljs.core.next.call(null,seq50723);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__50724,seq50723__$1);
});
...
var vec__50737 = cljs.core.split_with.call(null,(function (p1__50736_SHARP_){
return cljs.core.not_EQ_.call(null,p1__50736_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__50737,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__50737,(1),null);
...
var vec__50740 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__50740,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__50740,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__50743 = cljs.core.rest.call(null,remaining_tokens);
var G__50744 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__50743;
name_tokens = G__50744;
continue;
} else {
...
var vec__50747 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__50747,(0),null);
var arity = cljs.core.nth.call(null,vec__50747,(1),null);
var vec__50750 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__50750,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__50750,(1),null);
var vec__50753 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__50753,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__50753,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__50753,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__50753,(3),null);
...
var vec__50759 = result;
var munged_ns = cljs.core.nth.call(null,vec__50759,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__50759,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__50759,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__50759,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__50759,(4),null);
var arity = cljs.core.nth.call(null,vec__50759,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__50763 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__50763,(0),null);
var args = cljs.core.nth.call(null,vec__50763,(1),null);
var vec__50766 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__50766,(0),null);
var name = cljs.core.nth.call(null,vec__50766,(1),null);
...
var G__50769 = (arity + (1));
var G__50770 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__50771){
var vec__50772 = p__50771;
var arity = cljs.core.nth.call(null,vec__50772,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__50772,(1),null);
...
return cljs.core.get.call(null,arities,p1__50775_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__50776_SHARP_){
return cljs.core.drop.call(null,(2),p1__50776_SHARP_);
...
var args__31809__auto__ = [];
var len__31802__auto___50783 = arguments.length;
var i__31803__auto___50784 = (0);
while(true){
if((i__31803__auto___50784 < len__31802__auto___50783)){
args__31809__auto__.push((arguments[i__31803__auto___50784]));

var G__50785 = (i__31803__auto___50784 + (1));
i__31803__auto___50784 = G__50785;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__50779){
var vec__50780 = p__50779;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__50780,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq50777){
var G__50778 = cljs.core.first.call(null,seq50777);
var seq50777__$1 = cljs.core.next.call(null,seq50777);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__50778,seq50777__$1);
});
...
var G__50786 = arg;
var G__50786__$1 = (((G__50786 instanceof cljs.core.Keyword))?G__50786.fqn:null);
switch (G__50786__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__50788__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__50788__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__50788__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__50788__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__50789 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__50789,(0),null);
var fn_name = cljs.core.nth.call(null,vec__50789,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__50789,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__50789,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__50789,(4),null);
var arity = cljs.core.nth.call(null,vec__50789,(5),null);
...
}catch (e50793){var _e__35431__auto__ = e50793;
...
var G__50794 = (obj[cljs.core.first.call(null,path)]);
var G__50795 = cljs.core.rest.call(null,path);
obj = G__50794;
path = G__50795;
continue;
} else {
...
return (function (accum,p__50796){
var vec__50797 = p__50796;
var bit = cljs.core.nth.call(null,vec__50797,(0),null);
var protocol = cljs.core.nth.call(null,vec__50797,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__50800){
var vec__50801 = p__50800;
var ns = cljs.core.nth.call(null,vec__50801,(0),null);
var name = cljs.core.nth.call(null,vec__50801,(1),null);
var selector = cljs.core.nth.call(null,vec__50801,(2),null);
...
return (function (p__50805){
var vec__50806 = p__50805;
var munged_name = cljs.core.nth.call(null,vec__50806,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__50806,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__50806,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__50804_SHARP_){
return (obj[cljs.core.first.call(null,p1__50804_SHARP_)]);
});})(name,sorted_matches,vec__50806,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1510703507084
