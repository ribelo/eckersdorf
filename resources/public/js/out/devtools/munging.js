...
var o50621 = temp__5288__auto__;
var temp__5288__auto____$1 = (o50621["core"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o50622 = temp__5288__auto____$1;
return (o50622["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39560__auto__ = f;
return (o__39560__auto__["toString"]).call(o__39560__auto__);
} else {
return "";
}
}catch (e50623){var _ = e50623;
return "";
}});
...
try{var o__39560__auto___50625 = t;
(o__39560__auto___50625["cljs$lang$ctorPrWriter"]).call(o__39560__auto___50625,t,writer);
}catch (e50624){var __50626 = e50624;
}
...
var char_code = (function (){var o__39560__auto__ = (new String(char$));
return (o__39560__auto__["charCodeAt"]).call(o__39560__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39560__auto__ = String;
return (o__39560__auto__["fromCharCode"]).call(o__39560__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__50627 = num_code;
switch (G__50627) {
case (1):
return (185);
...
var o__39560__auto__ = String;
return (o__39560__auto__["fromCharCode"]).call(o__39560__auto__,superscript_code);
});
/**
...
}catch (e50629){var _e__39567__auto__ = e50629;
return false;
}})())){
...
var vec__50630 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__50630,(0),null);
...
if(cljs.core.truth_(temp__5288__auto__)){
var o50633 = temp__5288__auto__;
var temp__5288__auto____$1 = (o50633["dependencies_"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o50634 = temp__5288__auto____$1;
return (o50634["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31526__auto___50641 = arguments.length;
var i__31527__auto___50642 = (0);
while(true){
if((i__31527__auto___50642 < len__31526__auto___50641)){
args__31533__auto__.push((arguments[i__31527__auto___50642]));

var G__50643 = (i__31527__auto___50642 + (1));
i__31527__auto___50642 = G__50643;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__50637){
var vec__50638 = p__50637;
var ns_detector = cljs.core.nth.call(null,vec__50638,(0),null);
...
var G__50644 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__50645 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__50644;
remaining_tokens = G__50645;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq50635){
var G__50636 = cljs.core.first.call(null,seq50635);
var seq50635__$1 = cljs.core.next.call(null,seq50635);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__50636,seq50635__$1);
});
...
var vec__50649 = cljs.core.split_with.call(null,(function (p1__50648_SHARP_){
return cljs.core.not_EQ_.call(null,p1__50648_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__50649,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__50649,(1),null);
...
var vec__50652 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__50652,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__50652,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__50655 = cljs.core.rest.call(null,remaining_tokens);
var G__50656 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__50655;
name_tokens = G__50656;
continue;
} else {
...
var vec__50659 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__50659,(0),null);
var arity = cljs.core.nth.call(null,vec__50659,(1),null);
var vec__50662 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__50662,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__50662,(1),null);
var vec__50665 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__50665,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__50665,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__50665,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__50665,(3),null);
...
var vec__50671 = result;
var munged_ns = cljs.core.nth.call(null,vec__50671,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__50671,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__50671,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__50671,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__50671,(4),null);
var arity = cljs.core.nth.call(null,vec__50671,(5),null);
...
if(cljs.core.truth_(temp__5288__auto__)){
var vec__50675 = temp__5288__auto__;
var munged_name = cljs.core.nth.call(null,vec__50675,(0),null);
var args = cljs.core.nth.call(null,vec__50675,(1),null);
var vec__50678 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__50678,(0),null);
var name = cljs.core.nth.call(null,vec__50678,(1),null);
...
var G__50681 = (arity + (1));
var G__50682 = (function (){var temp__5288__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5288__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__50683){
var vec__50684 = p__50683;
var arity = cljs.core.nth.call(null,vec__50684,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__50684,(1),null);
...
return (function (p1__50687_SHARP_){
return cljs.core.get.call(null,arities,p1__50687_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__50688_SHARP_){
return cljs.core.drop.call(null,(2),p1__50688_SHARP_);
...
var args__31533__auto__ = [];
var len__31526__auto___50695 = arguments.length;
var i__31527__auto___50696 = (0);
while(true){
if((i__31527__auto___50696 < len__31526__auto___50695)){
args__31533__auto__.push((arguments[i__31527__auto___50696]));

var G__50697 = (i__31527__auto___50696 + (1));
i__31527__auto___50696 = G__50697;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__50691){
var vec__50692 = p__50691;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__50692,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq50689){
var G__50690 = cljs.core.first.call(null,seq50689);
var seq50689__$1 = cljs.core.next.call(null,seq50689);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__50690,seq50689__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__50700__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__50700__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__50700__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__50700__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__50701 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__50701,(0),null);
var fn_name = cljs.core.nth.call(null,vec__50701,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__50701,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__50701,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__50701,(4),null);
var arity = cljs.core.nth.call(null,vec__50701,(5),null);
...
var o__39560__auto__ = f;
return (o__39560__auto__["getBasis"]).call(o__39560__auto__);
});
/**
...
}catch (e50705){var _e__39567__auto__ = e50705;
...
var G__50706 = (obj[cljs.core.first.call(null,path)]);
var G__50707 = cljs.core.rest.call(null,path);
obj = G__50706;
path = G__50707;
continue;
} else {
...
return (function (accum,p__50708){
var vec__50709 = p__50708;
var bit = cljs.core.nth.call(null,vec__50709,(0),null);
var protocol = cljs.core.nth.call(null,vec__50709,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__50712){
var vec__50713 = p__50712;
var ns = cljs.core.nth.call(null,vec__50713,(0),null);
var name = cljs.core.nth.call(null,vec__50713,(1),null);
var selector = cljs.core.nth.call(null,vec__50713,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__50718,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__50718,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__50718,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__50716_SHARP_){
return (obj[cljs.core.first.call(null,p1__50716_SHARP_)]);
});})(name,sorted_matches,vec__50718,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1509397951846
