...
var o51499 = temp__5288__auto__;
var temp__5288__auto____$1 = (o51499["core"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o51500 = temp__5288__auto____$1;
return (o51500["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__34253__auto__ = f;
return (o__34253__auto__["toString"]).call(o__34253__auto__);
} else {
return "";
}
}catch (e51501){var _ = e51501;
return "";
}});
...
try{var o__34253__auto___51503 = t;
(o__34253__auto___51503["cljs$lang$ctorPrWriter"]).call(o__34253__auto___51503,t,writer);
}catch (e51502){var __51504 = e51502;
}
...
var char_code = (function (){var o__34253__auto__ = (new String(char$));
return (o__34253__auto__["charCodeAt"]).call(o__34253__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34253__auto__ = String;
return (o__34253__auto__["fromCharCode"]).call(o__34253__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__51505 = num_code;
switch (G__51505) {
case (1):
return (185);
...
var o__34253__auto__ = String;
return (o__34253__auto__["fromCharCode"]).call(o__34253__auto__,superscript_code);
});
/**
...
}catch (e51507){var _e__34260__auto__ = e51507;
return false;
}})())){
...
var vec__51508 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__51508,(0),null);
...
var or__30239__auto__ = (function (){var temp__5288__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5288__auto__)){
...
if(cljs.core.truth_(temp__5288__auto__)){
var o51511 = temp__5288__auto__;
var temp__5288__auto____$1 = (o51511["dependencies_"]);
if(cljs.core.truth_(temp__5288__auto____$1)){
var o51512 = temp__5288__auto____$1;
return (o51512["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31516__auto___51519 = arguments.length;
var i__31517__auto___51520 = (0);
while(true){
if((i__31517__auto___51520 < len__31516__auto___51519)){
args__31523__auto__.push((arguments[i__31517__auto___51520]));

var G__51521 = (i__31517__auto___51520 + (1));
i__31517__auto___51520 = G__51521;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31524__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__51515){
var vec__51516 = p__51515;
var ns_detector = cljs.core.nth.call(null,vec__51516,(0),null);
var effective_detector = (function (){var or__30239__auto__ = ns_detector;
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
} else {
...
var G__51522 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__51523 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__51522;
remaining_tokens = G__51523;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq51513){
var G__51514 = cljs.core.first.call(null,seq51513);
var seq51513__$1 = cljs.core.next.call(null,seq51513);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__51514,seq51513__$1);
});
...
var vec__51527 = cljs.core.split_with.call(null,(function (p1__51526_SHARP_){
return cljs.core.not_EQ_.call(null,p1__51526_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__51527,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__51527,(1),null);
...
var vec__51530 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__51530,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__51530,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__51533 = cljs.core.rest.call(null,remaining_tokens);
var G__51534 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__51533;
name_tokens = G__51534;
continue;
} else {
...
var vec__51537 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__51537,(0),null);
var arity = cljs.core.nth.call(null,vec__51537,(1),null);
var vec__51540 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__51540,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__51540,(1),null);
var vec__51543 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__51543,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__51543,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__51543,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__51543,(3),null);
...
var vec__51549 = result;
var munged_ns = cljs.core.nth.call(null,vec__51549,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__51549,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__51549,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__51549,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__51549,(4),null);
var arity = cljs.core.nth.call(null,vec__51549,(5),null);
...
if(cljs.core.truth_(temp__5288__auto__)){
var vec__51553 = temp__5288__auto__;
var munged_name = cljs.core.nth.call(null,vec__51553,(0),null);
var args = cljs.core.nth.call(null,vec__51553,(1),null);
var vec__51556 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__51556,(0),null);
var name = cljs.core.nth.call(null,vec__51556,(1),null);
...
var G__51559 = (arity + (1));
var G__51560 = (function (){var temp__5288__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5288__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__51561){
var vec__51562 = p__51561;
var arity = cljs.core.nth.call(null,vec__51562,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__51562,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30239__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__51565_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__51566_SHARP_);
...
var args__31523__auto__ = [];
var len__31516__auto___51573 = arguments.length;
var i__31517__auto___51574 = (0);
while(true){
if((i__31517__auto___51574 < len__31516__auto___51573)){
args__31523__auto__.push((arguments[i__31517__auto___51574]));

var G__51575 = (i__31517__auto___51574 + (1));
i__31517__auto___51574 = G__51575;
continue;
} else {
}
break;
...
var argseq__31524__auto__ = ((((1) < args__31523__auto__.length))?(new cljs.core.IndexedSeq(args__31523__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31524__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__51569){
var vec__51570 = p__51569;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__51570,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq51567){
var G__51568 = cljs.core.first.call(null,seq51567);
var seq51567__$1 = cljs.core.next.call(null,seq51567);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__51568,seq51567__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30239__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30227__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30239__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
} else {
...
var map__51578 = options;
var map__51578__$1 = ((((!((map__51578 == null)))?((((map__51578.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51578.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51578):map__51578);
var include_ns_QMARK_ = cljs.core.get.call(null,map__51578__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__51578__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__51578__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__51578__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__51579 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__51579,(0),null);
var fn_name = cljs.core.nth.call(null,vec__51579,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__51579,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__51579,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__51579,(4),null);
var arity = cljs.core.nth.call(null,vec__51579,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30227__auto__ = protocol_ns;
if(cljs.core.truth_(and__30227__auto__)){
return cljs.core.not.call(null,(function (){var and__30227__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30239__auto__ = protocol_part;
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
} else {
return fn_part;
...
var o__34253__auto__ = f;
return (o__34253__auto__["getBasis"]).call(o__34253__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30227__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30227__auto__)){
...
}catch (e51583){var _e__34260__auto__ = e51583;
...
var G__51584 = (obj[cljs.core.first.call(null,path)]);
var G__51585 = cljs.core.rest.call(null,path);
obj = G__51584;
path = G__51585;
continue;
} else {
...
var partition_bits = (function (){var or__30239__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
} else {
return (0);
...
return (function (accum,p__51586){
var vec__51587 = p__51586;
var bit = cljs.core.nth.call(null,vec__51587,(0),null);
var protocol = cljs.core.nth.call(null,vec__51587,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__51590){
var vec__51591 = p__51590;
var ns = cljs.core.nth.call(null,vec__51591,(0),null);
var name = cljs.core.nth.call(null,vec__51591,(1),null);
var selector = cljs.core.nth.call(null,vec__51591,(2),null);
...
return (function (p__51595){
var vec__51596 = p__51595;
var munged_name = cljs.core.nth.call(null,vec__51596,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__51596,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__51596,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__51594_SHARP_){
return (obj[cljs.core.first.call(null,p1__51594_SHARP_)]);
});})(name,sorted_matches,vec__51596,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1509094254699
