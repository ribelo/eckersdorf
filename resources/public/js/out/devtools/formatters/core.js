...
var and__30237__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__30237__auto__){
var or__30249__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e56852){var _e__39539__auto__ = e56852;
return false;
...
}catch (e56854){var _e__39539__auto__ = e56854;
return false;
...
}catch (e56856){var _e__39539__auto__ = e56856;
return false;
...
}catch (e56858){var _e__39539__auto__ = e56858;
return false;
...
}catch (e56860){var _e__39539__auto__ = e56860;
return false;
}})())){
...
}catch (e56862){var _e__39539__auto__ = e56862;
return false;
}})())){
...
var _STAR_current_state_STAR_56864 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__30249__auto__ = config;
if(cljs.core.truth_(or__30249__auto__)){
return or__30249__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_56864;
}});
});
...
return (function() { 
var G__56866__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e56865){var e = e56865;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__56866 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__56867__i = 0, G__56867__a = new Array(arguments.length -  0);
while (G__56867__i < G__56867__a.length) {G__56867__a[G__56867__i] = arguments[G__56867__i + 0]; ++G__56867__i;}
  args = new cljs.core.IndexedSeq(G__56867__a,0,null);
} 
return G__56866__delegate.call(this,args);};
G__56866.cljs$lang$maxFixedArity = 0;
G__56866.cljs$lang$applyTo = (function (arglist__56868){
var args = cljs.core.seq(arglist__56868);
return G__56866__delegate(args);
});
G__56866.cljs$core$IFn$_invoke$arity$variadic = G__56866__delegate;
return G__56866;
})()
;
});
...
var pre_handler = (function (){var or__30249__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__30249__auto__)){
return or__30249__auto__;
} else {
...
var post_handler = (function (){var or__30249__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__30249__auto__)){
return or__30249__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1507056186011
