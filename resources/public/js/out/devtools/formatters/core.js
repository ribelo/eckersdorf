...
var and__30511__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__30511__auto__){
var or__30523__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e52336){var _e__35431__auto__ = e52336;
return false;
...
var _STAR_current_state_STAR_52348 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__30523__auto__ = config;
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_52348;
}});
});
...
var pre_handler = (function (){var or__30523__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
...
var post_handler = (function (){var or__30523__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__30523__auto__)){
return or__30523__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1510609304944
