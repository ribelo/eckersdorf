...
var len__31801__auto___50837 = arguments.length;
var i__31802__auto___50838 = (0);
while(true){
if((i__31802__auto___50838 < len__31801__auto___50837)){
args__31808__auto__.push((arguments[i__31802__auto___50838]));

var G__50839 = (i__31802__auto___50838 + (1));
i__31802__auto___50838 = G__50839;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31809__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50834){
var G__50835 = cljs.core.first.call(null,seq50834);
var seq50834__$1 = cljs.core.next.call(null,seq50834);
var G__50836 = cljs.core.first.call(null,seq50834__$1);
var seq50834__$2 = cljs.core.next.call(null,seq50834__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__50835,G__50836,seq50834__$2);
});
...
if(cljs.core.truth_((function (){var or__30522__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__31193__auto__,writer__31194__auto__,opt__31195__auto__){
return cljs.core._write.call(null,writer__31194__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30510__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30510__auto__){
var or__30522__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50840_SHARP_){
return !((cljs.core.meta.call(null,p1__50840_SHARP_) == null));
})))){
...
var map__50841 = opts;
var map__50841__$1 = ((((!((map__50841 == null)))?((((map__50841.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50841.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50841):map__50841);
var markup_db = cljs.core.get.call(null,map__50841__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30522__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e50845){var _e__35430__auto__ = e50845;
return false;
}})();
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
...
}catch (e50847){var _e__35430__auto__ = e50847;
return false;
}}
})())){
...
var _STAR_current_state_STAR_50849 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__50850 = opts;
var map__50850__$1 = ((((!((map__50850 == null)))?((((map__50850.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50850.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50850):map__50850);
var markup_db = cljs.core.get.call(null,map__50850__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50849;
}});
...
;
var temp__5455__auto___50854 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___50854)){
var managed_print_level_50855 = temp__5455__auto___50854;
var _STAR_print_level_STAR_50853_50856 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_50855;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_50853_50856,managed_print_level_50855,temp__5455__auto___50854,writer,opts,job_fn){
return (function (p1__50852_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50852_SHARP_,null);
});})(_STAR_print_level_STAR_50853_50856,managed_print_level_50855,temp__5455__auto___50854,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_50853_50856;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1510602158806
