...
var len__31516__auto___51630 = arguments.length;
var i__31517__auto___51631 = (0);
while(true){
if((i__31517__auto___51631 < len__31516__auto___51630)){
args__31523__auto__.push((arguments[i__31517__auto___51631]));

var G__51632 = (i__31517__auto___51631 + (1));
i__31517__auto___51631 = G__51632;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq51627){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__51628,G__51629,seq51627__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__51633_SHARP_){
return !((cljs.core.meta.call(null,p1__51633_SHARP_) == null));
})))){
...
var map__51634 = opts;
var map__51634__$1 = ((((!((map__51634 == null)))?((((map__51634.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51634.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51634):map__51634);
var markup_db = cljs.core.get.call(null,map__51634__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e51638){var _e__34260__auto__ = e51638;
return false;
}})();
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
...
}catch (e51640){var _e__34260__auto__ = e51640;
return false;
}}
})())){
...
var _STAR_current_state_STAR_51642 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__51643 = opts;
...
var markup_db = cljs.core.get.call(null,map__51643__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_51642;
}});
...
;
var temp__5288__auto___51647 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5288__auto___51647)){
var managed_print_level_51648 = temp__5288__auto___51647;
var _STAR_print_level_STAR_51646_51649 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_51648;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_51646_51649,managed_print_level_51648,temp__5288__auto___51647,writer,opts,job_fn){
return (function (p1__51645_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__51645_SHARP_,null);
});})(_STAR_print_level_STAR_51646_51649,managed_print_level_51648,temp__5288__auto___51647,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_51646_51649;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1509094254862
