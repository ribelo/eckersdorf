...
var len__31802__auto___50840 = arguments.length;
var i__31803__auto___50841 = (0);
while(true){
if((i__31803__auto___50841 < len__31802__auto___50840)){
args__31809__auto__.push((arguments[i__31803__auto___50841]));

var G__50842 = (i__31803__auto___50841 + (1));
i__31803__auto___50841 = G__50842;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31810__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50837){
var G__50838 = cljs.core.first.call(null,seq50837);
var seq50837__$1 = cljs.core.next.call(null,seq50837);
var G__50839 = cljs.core.first.call(null,seq50837__$1);
var seq50837__$2 = cljs.core.next.call(null,seq50837__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__50838,G__50839,seq50837__$2);
});
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__31194__auto__,writer__31195__auto__,opt__31196__auto__){
return cljs.core._write.call(null,writer__31195__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50843_SHARP_){
return !((cljs.core.meta.call(null,p1__50843_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__50844__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e50848){var _e__35431__auto__ = e50848;
return false;
}})();
if(cljs.core.truth_(or__30522__auto__)){
return or__30522__auto__;
...
}catch (e50850){var _e__35431__auto__ = e50850;
return false;
}}
})())){
...
var _STAR_current_state_STAR_50852 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__50853 = opts;
var map__50853__$1 = ((((!((map__50853 == null)))?((((map__50853.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50853.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50853):map__50853);
var markup_db = cljs.core.get.call(null,map__50853__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50852;
}});
...
;
var temp__5455__auto___50857 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___50857)){
var managed_print_level_50858 = temp__5455__auto___50857;
var _STAR_print_level_STAR_50856_50859 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_50858;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_50856_50859,managed_print_level_50858,temp__5455__auto___50857,writer,opts,job_fn){
return (function (p1__50855_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50855_SHARP_,null);
});})(_STAR_print_level_STAR_50856_50859,managed_print_level_50858,temp__5455__auto___50857,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_50856_50859;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1510703507198
