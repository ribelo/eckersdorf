...
var G__51128 = devtools.prefs.pref.call(null,v);
v = G__51128;
continue;
} else {
return v;
...
var and__30227__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__30227__auto__){
var and__30227__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__30239__auto__ = (function (){try{if(!((value == null))){
...
}catch (e51131){var _e__39774__auto__ = e51131;
return false;
}})();
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
} else {
var or__30239__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e51135){var _e__39774__auto__ = e51135;
return false;
}})();
...
}catch (e51137){var _e__39774__auto__ = e51137;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__30227__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30227__auto__)){
var and__30227__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__30227__auto____$1){
...
var and__30227__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__30227__auto__)){
...
var or__30239__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
} else {
...
var and__30227__auto__ = (function (){var or__30239__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__30239__auto__)){
return or__30239__auto__;
} else {
...
var vec__51139 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__51139,(0),null);
var name = cljs.core.nth.call(null,vec__51139,(1),null);
...
var and__30227__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__30227__auto__)){
...
var or__30239__auto__ = typeof value === 'string';
if(or__30239__auto__){
return or__30239__auto__;
} else {
var or__30239__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__51142_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__51142_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1507757470926
