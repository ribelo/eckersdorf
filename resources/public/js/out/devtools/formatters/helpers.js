...
var G__50808 = devtools.prefs.pref.call(null,v);
v = G__50808;
continue;
} else {
return v;
...
}catch (e50811){var _e__35430__auto__ = e50811;
return false;
}})();
...
}catch (e50815){var _e__35430__auto__ = e50815;
return false;
}})();
...
}catch (e50817){var _e__35430__auto__ = e50817;
return false;
}}
}
});
...
var vec__50819 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__50819,(0),null);
var name = cljs.core.nth.call(null,vec__50819,(1),null);
...
return cljs.core.some.call(null,(function (p1__50822_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__50822_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1510602158640
