...
if(typeof devtools.toolbox.t_devtools$toolbox52544 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox52544 = (function (obj,header,style,tag,meta52545){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox52544.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52546,meta52545__$1){
var self__ = this;
var _52546__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox52544(self__.obj,self__.header,self__.style,self__.tag,meta52545__$1));
});

devtools.toolbox.t_devtools$toolbox52544.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52546){
var self__ = this;
var _52546__$1 = this;
return self__.meta52545;
});

devtools.toolbox.t_devtools$toolbox52544.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox52544.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox52544.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox52544.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox52544.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta52545","meta52545",-1120541108,null)], null);
});

devtools.toolbox.t_devtools$toolbox52544.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox52544.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox52544";

devtools.toolbox.t_devtools$toolbox52544.cljs$lang$ctorPrWriter = (function (this__30920__auto__,writer__30921__auto__,opt__30922__auto__){
return cljs.core._write.call(null,writer__30921__auto__,"devtools.toolbox/t_devtools$toolbox52544");
});

devtools.toolbox.__GT_t_devtools$toolbox52544 = (function devtools$toolbox$__GT_t_devtools$toolbox52544(obj__$1,header__$1,style__$1,tag__$1,meta52545){
return (new devtools.toolbox.t_devtools$toolbox52544(obj__$1,header__$1,style__$1,tag__$1,meta52545));
});

}

return (new devtools.toolbox.t_devtools$toolbox52544(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1509397953806
